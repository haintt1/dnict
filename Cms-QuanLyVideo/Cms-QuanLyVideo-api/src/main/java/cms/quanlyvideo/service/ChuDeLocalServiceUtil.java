...
/**
 * Provides the local service utility for ChuDe. This utility wraps
 * <code>cms.quanlyvideo.service.impl.ChuDeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ChuDeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>cms.quanlyvideo.service.impl.ChuDeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ChuDe addChuDe(ChuDe chuDe) {
		return getService().addChuDe(chuDe);
	}
	 ...
	 */
	public static ChuDe createChuDe(long id) {
		return getService().createChuDe(id);
	}
	 ...
	 */
	public static ChuDe deleteChuDe(ChuDe chuDe) {
		return getService().deleteChuDe(chuDe);
	}
	 ...
	 */
	public static ChuDe deleteChuDe(long id) throws PortalException {
		return getService().deleteChuDe(id);
	}
	...
	public static ChuDe fetchChuDe(long id) {
		return getService().fetchChuDe(id);
	}
	 ...
	 * @throws PortalException if a chu de with the primary key could not be found
	 */
	public static ChuDe getChuDe(long id) throws PortalException {
		return getService().getChuDe(id);
	}
	 ...
	 */
	public static List<ChuDe> getChuDes(int start, int end) {
		return getService().getChuDes(start, end);
	}
	 ...
	 */
	public static int getChuDesCount() {
		return getService().getChuDesCount();
	}
	 ...
	 */
	public static ChuDe updateChuDe(ChuDe chuDe) {
		return getService().updateChuDe(chuDe);
	}

	public static ChuDeLocalService getService() {
		return _service;
	}

	public static void setService(ChuDeLocalService service) {
		_service = service;
	}

	private static volatile ChuDeLocalService _service;
