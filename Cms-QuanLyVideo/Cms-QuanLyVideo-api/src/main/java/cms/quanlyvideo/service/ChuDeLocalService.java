...
/**
 * Provides the local service interface for ChuDe. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ChuDeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ChuDeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>cms.quanlyvideo.service.impl.ChuDeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the chu de local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ChuDeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ChuDe createChuDe(long id);
	...
	public ChuDe deleteChuDe(ChuDe chuDe);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ChuDe deleteChuDe(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ChuDe fetchChuDe(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ChuDe getChuDe(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ChuDe> getChuDes(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ChuDe updateChuDe(ChuDe chuDe);
