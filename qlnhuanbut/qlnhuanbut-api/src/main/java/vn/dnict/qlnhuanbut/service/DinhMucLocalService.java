...
/**
 * Provides the local service interface for DinhMuc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see DinhMucLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DinhMucLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.qlnhuanbut.service.impl.DinhMucLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dinh muc local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DinhMucLocalServiceUtil} if injection and service tracking are not available.
	 */
