...
/**
 * Provides the local service utility for DinhMuc. This utility wraps
 * <code>vn.dnict.qlnhuanbut.service.impl.DinhMucLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DinhMucLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>vn.dnict.qlnhuanbut.service.impl.DinhMucLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DinhMuc addDinhMuc(DinhMuc dinhMuc) {
		return getService().addDinhMuc(dinhMuc);
	}
	 ...
	 */
	public static DinhMuc createDinhMuc(long id) {
		return getService().createDinhMuc(id);
	}
	 ...
	 */
	public static DinhMuc deleteDinhMuc(DinhMuc dinhMuc) {
		return getService().deleteDinhMuc(dinhMuc);
	}
	 ...
	 */
	public static DinhMuc deleteDinhMuc(long id) throws PortalException {
		return getService().deleteDinhMuc(id);
	}
	...
	public static DinhMuc fetchDinhMuc(long id) {
		return getService().fetchDinhMuc(id);
	}
	 ...
	 * @throws PortalException if a dinh muc with the primary key could not be found
	 */
	public static DinhMuc getDinhMuc(long id) throws PortalException {
		return getService().getDinhMuc(id);
	}
	 ...
	 */
	public static List<DinhMuc> getDinhMucs(int start, int end) {
		return getService().getDinhMucs(start, end);
	}
	 ...
	 */
	public static int getDinhMucsCount() {
		return getService().getDinhMucsCount();
	}
	 ...
	 */
	public static DinhMuc updateDinhMuc(DinhMuc dinhMuc) {
		return getService().updateDinhMuc(dinhMuc);
	}

	public static DinhMucLocalService getService() {
		return _service;
	}

	public static void setService(DinhMucLocalService service) {
		_service = service;
	}

	private static volatile DinhMucLocalService _service;
