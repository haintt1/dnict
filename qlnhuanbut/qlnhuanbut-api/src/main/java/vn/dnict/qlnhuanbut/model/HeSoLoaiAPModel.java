...
/**
 * The base model interface for the HeSoLoaiAP service. Represents a row in the &quot;cw_nhuanbut_hesoloaiAP&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>vn.dnict.qlnhuanbut.model.impl.HeSoLoaiAPModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>vn.dnict.qlnhuanbut.model.impl.HeSoLoaiAPImpl</code>.
 * </p>
 *
 * @author dnict
 * @see HeSoLoaiAP
 ...
 */
@ProviderType
public interface HeSoLoaiAPModel extends BaseModel<HeSoLoaiAP> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a he so loai ap model instance should use the {@link HeSoLoaiAP} interface instead.
	 */
