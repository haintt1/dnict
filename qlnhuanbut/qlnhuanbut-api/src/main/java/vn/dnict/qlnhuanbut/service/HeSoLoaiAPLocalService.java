...
/**
 * Provides the local service interface for HeSoLoaiAP. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see HeSoLoaiAPLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HeSoLoaiAPLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.qlnhuanbut.service.impl.HeSoLoaiAPLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the he so loai ap local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HeSoLoaiAPLocalServiceUtil} if injection and service tracking are not available.
	 */
