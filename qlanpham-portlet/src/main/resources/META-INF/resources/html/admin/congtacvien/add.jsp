...
%>
<portlet:actionURL name="saveCTV" var="saveCTVURL">
				...
				<div aria-multiselectable="true" class="panel-group" role="tablist">
					<fieldset aria-labelledby="Title" class=" " role="group">
						<div aria-labelledby="Header" class="in  " id="Content" role="presentation">
							...
							<aui:form name="formAddThongTin" action="<%=saveCTVURL %>"
								method="post">
								<table class="tbcoreadmin" style="width: 100%">
									<tr>
										<td>
											<label class="control-label">Họ tên cộng tác viên</label>
											<aui:input name="hoTen" label="" type="input">
										...
										<td>
											...
											<aui:input name="email" label="" type="input">
												<aui:validator name="required"></aui:validator>
											</aui:input>
										</td>	
									</tr>
									<tr>
										<td colspan="2">
											...
											<aui:input name="thongTin" label="" type="textarea" />
										</td>	
									</tr>
									<tr>
										<td colspan="100">
									...
									<tr>
										<td>
											...
											<aui:input name="status" type="checkbox" label="" checked="true"/>
										</td>
									</tr>
									<tr>
