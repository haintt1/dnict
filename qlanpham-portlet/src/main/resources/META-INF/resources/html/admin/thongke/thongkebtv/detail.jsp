...
<%
	...
	String tabThongKeBTV = ParamUtil.getString(request, "tabs1", AnPhamConfig.tabThongKeBTV);
	SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
	long userId = ParamUtil.getLong(request, "userId");
	List<User> objUser = ThongKeAdminUtil.getUsersByID(userId);
	String fullname = objUser.get(0).getFullName();
	...
	portletURL.setParameter("jspPage", "/html/admin/thongke/thongkebtv/detail.jsp");
	
	List<AnPham_TapChi> anPhamList = ThongKeAdminUtil.thongKeAnPhamByBTV(userId, ngaybatdau, ngayketthuc, trangThaiTinBai);
%>
...
<div class="container-fluid mt-4">
			...
			<aui:form action="<%=searchURL.toString() %>">
				...
				<div class="d-flex justify-content-center">
					<aui:button-row>
						...
						<aui:button type="button" cssClass="btn btn-success" id="btnXuatThongKeBTV" value="Xuất Excel"/>
    ...
    <div class="card">
        <div class="card-body">
			...
			<table class="table table-bordered table-hover" id="thongkechitietbtv">
				<thead>
				    <tr>
				      <th scope="col">#</th>
				...
				<tbody>
					...
					<tr>
				      ...
				      <td><%=ap.getTen() %></td>
				      <%
				      	AnPham_Loai loaianpham = AnPham_LoaiLocalServiceUtil.fetchAnPham_Loai(ap.getLoaiId());
				      %>
				      <td><%=loaianpham.getTen() %></td>
...
<script>
    $(document).ready(function () {
        $("#<portlet:namespace />btnXuatThongKeBTV").click(function () {
            $("#thongkechitietbtv").tableExport({
	            type: "xls",               
	            fileName: "ThongKeChiTietBienTapVien",         
            });
        });
    });
</script>
