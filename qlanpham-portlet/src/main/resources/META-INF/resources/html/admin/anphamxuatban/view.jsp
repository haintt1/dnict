...
<portlet:renderURL var="addURL">
	<portlet:param name="jspPage"
		value="/html/admin/anphamxuatban/add.jsp" />
	<portlet:param name="itemSelectorURL" value="<%= itemSelectorURL %>" />
</portlet:renderURL>
<portlet:renderURL var="softDeleteURL">
	<portlet:param name="jspPage" value="/html/admin/anphamxuatban/trash.jsp" />
</portlet:renderURL>
	...
	<div class="card">
		<div class="card-body">
					...
					<div class="col-md-6">
						<aui:select name="anPham" label="Ấn phẩm" id="selectLoai">
							...
							<%
								...
								%>
							<aui:option value="<%=listLoai.getId()%>" selected="<%=listLoai.getOrders() == 3 %>"><%=listLoai.getTen()%></aui:option>
							<% } %>
						</aui:select>
					</div>
					<div class="col-md-6">
			...
			<div class="new-container-pm ">
				<portlet:renderURL var="editAnPhamXuatBanURL">
					<portlet:param name="id" value="<%=String.valueOf(listTapChi.get(a).getId())%>" />
					<portlet:param name="jspPage" value="/html/admin/anphamxuatban/edit.jsp" />
					<portlet:param name="itemSelectorURL" value="<%= itemSelectorURL %>" />
				</portlet:renderURL>
				<portlet:renderURL var="xemPhienBanURL">
					<portlet:param name="id" value="<%=String.valueOf(listTapChi.get(a).getId())%>" />
					<portlet:param name="jspPage" value="/html/admin/anphamxuatban/xemphienban.jsp" />
				</portlet:renderURL>
				<portlet:actionURL name="deleteAnPhamXuatBan" var="deleteAnPhamXuatBanURL">
					<portlet:param name="id" value="<%=String.valueOf(listTapChi.get(a).getId())%>" />
					<portlet:param name="jspPage" value="/html/admin/anphamxuatban/view.jsp" />
				</portlet:actionURL>
				<div class="dropdown">
					...
					<div id="myDropdown_<%=listTapChi.get(a).getId()%>"
						...
						<%
							...
							if(listTapChi.get(a).getLoaiTin()==0){
								chonLoaiTin = editAnPhamXuatBanURL;
								deleteTin = deleteAnPhamXuatBanURL.toString();
							} else {
								chonLoaiTin = editAnPhamXuatBanURL;
								deleteTin = deleteAnPhamXuatBanURL.toString();
							}
