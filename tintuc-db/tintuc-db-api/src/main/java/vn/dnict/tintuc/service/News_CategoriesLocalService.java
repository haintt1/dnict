...
/**
 * Provides the local service interface for News_Categories. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see News_CategoriesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface News_CategoriesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.tintuc.service.impl.News_CategoriesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the news_ categories local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link News_CategoriesLocalServiceUtil} if injection and service tracking are not available.
	 */
