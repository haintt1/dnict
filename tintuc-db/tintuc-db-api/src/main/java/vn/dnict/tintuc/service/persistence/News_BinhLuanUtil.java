...
/**
 * The persistence utility for the news_ binh luan service. This utility wraps <code>vn.dnict.tintuc.service.persistence.impl.News_BinhLuanPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author dnict
 * @see News_BinhLuanPersistence
 * @generated
 */
public class News_BinhLuanUtil {
	 ...
	 */
	public static void clearCache(News_BinhLuan news_BinhLuan) {
		getPersistence().clearCache(news_BinhLuan);
	}
	 ...
	 */
	public static Map<Serializable, News_BinhLuan> fetchByPrimaryKeys(
	 ...
	 */
	public static List<News_BinhLuan> findWithDynamicQuery(
	 ...
	 */
	public static News_BinhLuan update(News_BinhLuan news_BinhLuan) {
		return getPersistence().update(news_BinhLuan);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static News_BinhLuan update(
		News_BinhLuan news_BinhLuan, ServiceContext serviceContext) {

		return getPersistence().update(news_BinhLuan, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(News_BinhLuan news_BinhLuan) {
		getPersistence().cacheResult(news_BinhLuan);
	}
	 ...
	 */
	public static void cacheResult(List<News_BinhLuan> news_BinhLuans) {
		getPersistence().cacheResult(news_BinhLuans);
	}
	 ...
	 */
	public static News_BinhLuan create(long id) {
	 ...
	 */
	public static News_BinhLuan remove(long id)
		throws vn.dnict.tintuc.exception.NoSuchNews_BinhLuanException {

		return getPersistence().remove(id);
	}

	public static News_BinhLuan updateImpl(News_BinhLuan news_BinhLuan) {
		return getPersistence().updateImpl(news_BinhLuan);
	}
	 ...
	 * @throws NoSuchNews_BinhLuanException if a news_ binh luan with the primary key could not be found
	 */
	public static News_BinhLuan findByPrimaryKey(long id)
		throws vn.dnict.tintuc.exception.NoSuchNews_BinhLuanException {
	 ...
	 */
	public static News_BinhLuan fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<News_BinhLuan> findAll() {
	 ...
	 */
	public static List<News_BinhLuan> findAll(int start, int end) {
	...
	public static News_BinhLuanPersistence getPersistence() {
		return _persistence;
	}

	private static volatile News_BinhLuanPersistence _persistence;
