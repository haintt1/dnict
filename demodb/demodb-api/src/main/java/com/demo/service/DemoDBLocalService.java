...
/**
 * Provides the local service interface for DemoDB. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DemoDBLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DemoDBLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.demo.service.impl.DemoDBLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the demo db local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DemoDBLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DemoDB addDemoDB(DemoDB demoDB);
	...
	public DemoDB createDemoDB(long id);
	...
	public DemoDB deleteDemoDB(DemoDB demoDB);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DemoDB deleteDemoDB(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DemoDB fetchDemoDB(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DemoDB getDemoDB(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DemoDB> getDemoDBs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DemoDB updateDemoDB(DemoDB demoDB);
