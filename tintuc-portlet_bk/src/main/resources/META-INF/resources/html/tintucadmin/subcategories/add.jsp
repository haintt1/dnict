...
<title>Thêm mới thư viện</title>
</head>
<body>
<%
	String tabChuyenMuc = TinTucAdminField.value_tabchuyenmuc;
%>
<portlet:actionURL name="saveSubCategory" var="saveSubCategoryURL">
				...
				<div aria-multiselectable="true" class="panel-group" role="tablist">
					<fieldset aria-labelledby="Title" class=" " role="group">
						<div aria-labelledby="Header" class="in  " id="Content" role="presentation">
							...
							<aui:form name="formAddThongTin" action="<%=saveSubCategoryURL.toString() %>"
								method="post">
