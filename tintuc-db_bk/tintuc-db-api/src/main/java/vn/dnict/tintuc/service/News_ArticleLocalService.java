...
/**
 * Provides the local service interface for News_Article. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see News_ArticleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface News_ArticleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.tintuc.service.impl.News_ArticleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the news_ article local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link News_ArticleLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public News_Article addNews_Article(News_Article news_Article);
	...
	public News_Article createNews_Article(long id);
	...
	public News_Article deleteNews_Article(long id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public News_Article deleteNews_Article(News_Article news_Article);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public News_Article fetchNews_Article(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public News_Article getNews_Article(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<News_Article> getNews_Articles(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public News_Article updateNews_Article(News_Article news_Article);
