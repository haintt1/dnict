...
/**
 * Provides the local service interface for News_Subcategories. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see News_SubcategoriesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface News_SubcategoriesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.tintuc.service.impl.News_SubcategoriesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the news_ subcategories local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link News_SubcategoriesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public News_Subcategories addNews_Subcategories(
	...
	public News_Subcategories createNews_Subcategories(long id);
	...
	public News_Subcategories deleteNews_Subcategories(long id)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public News_Subcategories deleteNews_Subcategories(
		News_Subcategories news_Subcategories);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public News_Subcategories fetchNews_Subcategories(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public News_Subcategories getNews_Subcategories(long id)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<News_Subcategories> getNews_Subcategorieses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public News_Subcategories updateNews_Subcategories(
		News_Subcategories news_Subcategories);
