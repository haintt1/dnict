...
/**
 * Provides the local service interface for BangQuangCao. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see BangQuangCaoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BangQuangCaoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.qlquangcao.service.impl.BangQuangCaoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the bang quang cao local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BangQuangCaoLocalServiceUtil} if injection and service tracking are not available.
	 */
