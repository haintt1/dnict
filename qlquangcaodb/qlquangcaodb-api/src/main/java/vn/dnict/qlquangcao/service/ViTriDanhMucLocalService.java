...
/**
 * Provides the local service interface for ViTriDanhMuc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see ViTriDanhMucLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ViTriDanhMucLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.qlquangcao.service.impl.ViTriDanhMucLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the vi tri danh muc local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ViTriDanhMucLocalServiceUtil} if injection and service tracking are not available.
	 */
