...
/**
 * Provides the local service utility for BangQuangCao. This utility wraps
 * <code>vn.dnict.qlquangcao.service.impl.BangQuangCaoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class BangQuangCaoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>vn.dnict.qlquangcao.service.impl.BangQuangCaoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static BangQuangCao addBangQuangCao(BangQuangCao bangQuangCao) {
		return getService().addBangQuangCao(bangQuangCao);
	}
	 ...
	 */
	public static BangQuangCao createBangQuangCao(long id) {
		return getService().createBangQuangCao(id);
	}
	 ...
	 */
	public static BangQuangCao deleteBangQuangCao(BangQuangCao bangQuangCao) {
		return getService().deleteBangQuangCao(bangQuangCao);
	}
	 ...
	 */
	public static BangQuangCao deleteBangQuangCao(long id)
		throws PortalException {

		return getService().deleteBangQuangCao(id);
	}
	...
	public static BangQuangCao fetchBangQuangCao(long id) {
		return getService().fetchBangQuangCao(id);
	}
	 ...
	 * @throws PortalException if a bang quang cao with the primary key could not be found
	 */
	public static BangQuangCao getBangQuangCao(long id) throws PortalException {
		return getService().getBangQuangCao(id);
	}
	 ...
	 */
	public static List<BangQuangCao> getBangQuangCaos(int start, int end) {
		return getService().getBangQuangCaos(start, end);
	}
	 ...
	 */
	public static int getBangQuangCaosCount() {
		return getService().getBangQuangCaosCount();
	}
	 ...
	 */
	public static BangQuangCao updateBangQuangCao(BangQuangCao bangQuangCao) {
		return getService().updateBangQuangCao(bangQuangCao);
	}

	public static BangQuangCaoLocalService getService() {
		return _service;
	}

	public static void setService(BangQuangCaoLocalService service) {
		_service = service;
	}

	private static volatile BangQuangCaoLocalService _service;
