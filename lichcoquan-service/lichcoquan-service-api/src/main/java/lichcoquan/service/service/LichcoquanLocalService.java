...
/**
 * Provides the local service interface for Lichcoquan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author BinhNT
 * @see LichcoquanLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LichcoquanLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>lichcoquan.service.service.impl.LichcoquanLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the lichcoquan local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LichcoquanLocalServiceUtil} if injection and service tracking are not available.
	 */
