...
/**
 * The persistence interface for the can bo service.
 *
 * <p>
 ...
 */
@ProviderType
public interface CanBoPersistence extends BasePersistence<CanBo> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CanBoUtil} to access the can bo persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<CanBo> findByten(String ten);
	 ...
	 */
	public java.util.List<CanBo> findByten(String ten, int start, int end);
	 ...
	 */
	public java.util.List<CanBo> findByten(
		String ten, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<CanBo>
			orderByComparator);
	 ...
	 */
	public void cacheResult(java.util.List<CanBo> canBos);
	 ...
	 * @return the can bos
	 */
	public java.util.List<CanBo> findAll();
	 ...
	 */
	public java.util.List<CanBo> findAll(int start, int end);
