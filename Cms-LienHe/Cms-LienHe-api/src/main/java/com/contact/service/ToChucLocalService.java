...
/**
 * Provides the local service interface for ToChuc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ToChucLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ToChucLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.contact.service.impl.ToChucLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the to chuc local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ToChucLocalServiceUtil} if injection and service tracking are not available.
	 */
