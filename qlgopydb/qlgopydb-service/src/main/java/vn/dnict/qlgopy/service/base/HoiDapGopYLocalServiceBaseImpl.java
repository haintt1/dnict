...
import vn.dnict.qlgopy.service.HoiDapGopYLocalService;
...
/**
 * Provides the base implementation for the hoi dap gop y local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dnict.qlgopy.service.impl.HoiDapGopYLocalServiceImpl}.
 * </p>
 *
 * @author dnict
 * @see vn.dnict.qlgopy.service.impl.HoiDapGopYLocalServiceImpl
 * @generated
 */
public abstract class HoiDapGopYLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HoiDapGopYLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HoiDapGopYLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HoiDapGopYLocalServiceUtil</code>.
	 */
	...
	public HoiDapGopY addHoiDapGopY(HoiDapGopY hoiDapGopY) {
		...
		return hoiDapGopYPersistence.update(hoiDapGopY);
	}
	...
	public HoiDapGopY createHoiDapGopY(long id) {
		return hoiDapGopYPersistence.create(id);
	}
	...
	public HoiDapGopY deleteHoiDapGopY(long id) throws PortalException {
		return hoiDapGopYPersistence.remove(id);
	}
	...
	public HoiDapGopY deleteHoiDapGopY(HoiDapGopY hoiDapGopY) {
		return hoiDapGopYPersistence.remove(hoiDapGopY);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HoiDapGopY.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return hoiDapGopYPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return hoiDapGopYPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return hoiDapGopYPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return hoiDapGopYPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public HoiDapGopY fetchHoiDapGopY(long id) {
		return hoiDapGopYPersistence.fetchByPrimaryKey(id);
	}
	...
	public HoiDapGopY getHoiDapGopY(long id) throws PortalException {
		return hoiDapGopYPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(hoiDapGopYLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(HoiDapGopY.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			hoiDapGopYLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(HoiDapGopY.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return hoiDapGopYPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return hoiDapGopYLocalService.deleteHoiDapGopY(
			(HoiDapGopY)persistedModel);
	}

	public BasePersistence<HoiDapGopY> getBasePersistence() {
		return hoiDapGopYPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return hoiDapGopYPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<HoiDapGopY> getHoiDapGopYs(int start, int end) {
		return hoiDapGopYPersistence.findAll(start, end);
	}
	...
	public int getHoiDapGopYsCount() {
		return hoiDapGopYPersistence.countAll();
	}
	...
	protected void deactivate() {
		HoiDapGopYLocalServiceUtil.setService(null);
	}

	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HoiDapGopYLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		hoiDapGopYLocalService = (HoiDapGopYLocalService)aopProxy;

		HoiDapGopYLocalServiceUtil.setService(hoiDapGopYLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HoiDapGopYLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = hoiDapGopYPersistence.getDataSource();
	...
	protected HoiDapGopYLocalService hoiDapGopYLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HoiDapGopYLocalServiceBaseImpl.class);
