...
/**
 * Provides the local service utility for AnPham_DinhKemFile. This utility wraps
 * <code>qlanphamdb.service.impl.AnPham_DinhKemFileLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AnPham_DinhKemFileLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>qlanphamdb.service.impl.AnPham_DinhKemFileLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AnPham_DinhKemFile addAnPham_DinhKemFile(
		AnPham_DinhKemFile anPham_DinhKemFile) {

		return getService().addAnPham_DinhKemFile(anPham_DinhKemFile);
	}
	 ...
	 */
	public static AnPham_DinhKemFile createAnPham_DinhKemFile(long id) {
		return getService().createAnPham_DinhKemFile(id);
	}
	 ...
	 */
	public static AnPham_DinhKemFile deleteAnPham_DinhKemFile(
		AnPham_DinhKemFile anPham_DinhKemFile) {

		return getService().deleteAnPham_DinhKemFile(anPham_DinhKemFile);
	}
	 ...
	 */
	public static AnPham_DinhKemFile deleteAnPham_DinhKemFile(long id)
		throws PortalException {

		return getService().deleteAnPham_DinhKemFile(id);
	}
	...
	public static AnPham_DinhKemFile fetchAnPham_DinhKemFile(long id) {
		return getService().fetchAnPham_DinhKemFile(id);
	}
	 ...
	 * @throws PortalException if a an pham_ dinh kem file with the primary key could not be found
	 */
	public static AnPham_DinhKemFile getAnPham_DinhKemFile(long id)
		throws PortalException {

		return getService().getAnPham_DinhKemFile(id);
	}
	 ...
	 */
	public static List<AnPham_DinhKemFile> getAnPham_DinhKemFiles(
		int start, int end) {

		return getService().getAnPham_DinhKemFiles(start, end);
	}
	 ...
	 */
	public static int getAnPham_DinhKemFilesCount() {
		return getService().getAnPham_DinhKemFilesCount();
	}
	 ...
	 */
	public static AnPham_DinhKemFile updateAnPham_DinhKemFile(
		AnPham_DinhKemFile anPham_DinhKemFile) {

		return getService().updateAnPham_DinhKemFile(anPham_DinhKemFile);
	}

	public static AnPham_DinhKemFileLocalService getService() {
		return _service;
	}

	private static volatile AnPham_DinhKemFileLocalService _service;
