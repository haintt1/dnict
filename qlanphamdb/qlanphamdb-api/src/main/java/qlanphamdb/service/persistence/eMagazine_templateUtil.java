...
/**
 * The persistence utility for the e magazine_template service. This utility wraps <code>qlanphamdb.service.persistence.impl.eMagazine_templatePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author dnict
 * @see eMagazine_templatePersistence
 * @generated
 */
public class eMagazine_templateUtil {
	 ...
	 */
	public static void clearCache(eMagazine_template eMagazine_template) {
		getPersistence().clearCache(eMagazine_template);
	}
	 ...
	 */
	public static Map<Serializable, eMagazine_template> fetchByPrimaryKeys(
	 ...
	 */
	public static List<eMagazine_template> findWithDynamicQuery(
	 ...
	 */
	public static eMagazine_template update(
		eMagazine_template eMagazine_template) {

		return getPersistence().update(eMagazine_template);
	}
	 ...
	 */
	public static eMagazine_template update(
		eMagazine_template eMagazine_template, ServiceContext serviceContext) {

		return getPersistence().update(eMagazine_template, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(eMagazine_template eMagazine_template) {
		getPersistence().cacheResult(eMagazine_template);
	}
	...
	public static void cacheResult(
		List<eMagazine_template> eMagazine_templates) {

		getPersistence().cacheResult(eMagazine_templates);
	}
	 ...
	 */
	public static eMagazine_template create(long id) {
	 ...
	 */
	public static eMagazine_template remove(long id)
		throws qlanphamdb.exception.NoSucheMagazine_templateException {

		return getPersistence().remove(id);
	}

	public static eMagazine_template updateImpl(
		eMagazine_template eMagazine_template) {

		return getPersistence().updateImpl(eMagazine_template);
	}
	 ...
	 * @throws NoSucheMagazine_templateException if a e magazine_template with the primary key could not be found
	 */
	public static eMagazine_template findByPrimaryKey(long id)
		throws qlanphamdb.exception.NoSucheMagazine_templateException {
	 ...
	 */
	public static eMagazine_template fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<eMagazine_template> findAll() {
	 ...
	 */
	public static List<eMagazine_template> findAll(int start, int end) {
	...
	public static eMagazine_templatePersistence getPersistence() {
		return _persistence;
	}

	private static volatile eMagazine_templatePersistence _persistence;
