...
/**
 * The persistence utility for the an pham_ binh luan service. This utility wraps <code>qlanphamdb.service.persistence.impl.AnPham_BinhLuanPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author dnict
 * @see AnPham_BinhLuanPersistence
 * @generated
 */
public class AnPham_BinhLuanUtil {
	 ...
	 */
	public static void clearCache(AnPham_BinhLuan anPham_BinhLuan) {
		getPersistence().clearCache(anPham_BinhLuan);
	}
	 ...
	 */
	public static Map<Serializable, AnPham_BinhLuan> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AnPham_BinhLuan> findWithDynamicQuery(
	 ...
	 */
	public static AnPham_BinhLuan update(AnPham_BinhLuan anPham_BinhLuan) {
		return getPersistence().update(anPham_BinhLuan);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static AnPham_BinhLuan update(
		AnPham_BinhLuan anPham_BinhLuan, ServiceContext serviceContext) {

		return getPersistence().update(anPham_BinhLuan, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(AnPham_BinhLuan anPham_BinhLuan) {
		getPersistence().cacheResult(anPham_BinhLuan);
	}
	 ...
	 */
	public static void cacheResult(List<AnPham_BinhLuan> anPham_BinhLuans) {
		getPersistence().cacheResult(anPham_BinhLuans);
	}
	 ...
	 */
	public static AnPham_BinhLuan create(long id) {
	 ...
	 */
	public static AnPham_BinhLuan remove(long id)
		throws qlanphamdb.exception.NoSuchAnPham_BinhLuanException {

		return getPersistence().remove(id);
	}

	public static AnPham_BinhLuan updateImpl(AnPham_BinhLuan anPham_BinhLuan) {
		return getPersistence().updateImpl(anPham_BinhLuan);
	}
	 ...
	 * @throws NoSuchAnPham_BinhLuanException if a an pham_ binh luan with the primary key could not be found
	 */
	public static AnPham_BinhLuan findByPrimaryKey(long id)
		throws qlanphamdb.exception.NoSuchAnPham_BinhLuanException {
	 ...
	 */
	public static AnPham_BinhLuan fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<AnPham_BinhLuan> findAll() {
	 ...
	 */
	public static List<AnPham_BinhLuan> findAll(int start, int end) {
	...
	public static AnPham_BinhLuanPersistence getPersistence() {
		return _persistence;
	}

	private static volatile AnPham_BinhLuanPersistence _persistence;
