...
/**
 * The persistence interface for the e magazine_ logs service.
 *
 * <p>
 ...
 *
 * @author dnict
 * @see eMagazine_LogsUtil
 * @generated
 */
@ProviderType
public interface eMagazine_LogsPersistence
	extends BasePersistence<eMagazine_Logs> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link eMagazine_LogsUtil} to access the e magazine_ logs persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<eMagazine_Logs> eMagazine_Logses);
	 ...
	 */
	public java.util.List<eMagazine_Logs> findAll();
	 ...
	 */
	public java.util.List<eMagazine_Logs> findAll(int start, int end);
	...
	public java.util.List<eMagazine_Logs> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<eMagazine_Logs>
			orderByComparator);
