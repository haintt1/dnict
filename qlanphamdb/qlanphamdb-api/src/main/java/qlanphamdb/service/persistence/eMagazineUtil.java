...
/**
 * The persistence utility for the e magazine service. This utility wraps <code>qlanphamdb.service.persistence.impl.eMagazinePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author dnict
 * @see eMagazinePersistence
 * @generated
 */
public class eMagazineUtil {
	 ...
	 */
	public static void clearCache(eMagazine eMagazine) {
		getPersistence().clearCache(eMagazine);
	}
	 ...
	 */
	public static Map<Serializable, eMagazine> fetchByPrimaryKeys(
	 ...
	 */
	public static List<eMagazine> findWithDynamicQuery(
	...
	public static List<eMagazine> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<eMagazine> orderByComparator) {
	 ...
	 */
	public static eMagazine update(eMagazine eMagazine) {
		return getPersistence().update(eMagazine);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static eMagazine update(
		eMagazine eMagazine, ServiceContext serviceContext) {

		return getPersistence().update(eMagazine, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(eMagazine eMagazine) {
		getPersistence().cacheResult(eMagazine);
	}
	 ...
	 */
	public static void cacheResult(List<eMagazine> eMagazines) {
		getPersistence().cacheResult(eMagazines);
	}
	 ...
	 */
	public static eMagazine create(long id) {
	 ...
	 */
	public static eMagazine remove(long id)
		throws qlanphamdb.exception.NoSucheMagazineException {

		return getPersistence().remove(id);
	}

	public static eMagazine updateImpl(eMagazine eMagazine) {
		return getPersistence().updateImpl(eMagazine);
	}
	 ...
	 * @throws NoSucheMagazineException if a e magazine with the primary key could not be found
	 */
	public static eMagazine findByPrimaryKey(long id)
		throws qlanphamdb.exception.NoSucheMagazineException {
	 ...
	 */
	public static eMagazine fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<eMagazine> findAll() {
	 ...
	 */
	public static List<eMagazine> findAll(int start, int end) {
	...
	public static eMagazinePersistence getPersistence() {
		return _persistence;
	}

	private static volatile eMagazinePersistence _persistence;
