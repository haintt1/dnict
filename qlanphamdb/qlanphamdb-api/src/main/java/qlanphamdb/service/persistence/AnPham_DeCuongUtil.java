...
/**
 * The persistence utility for the an pham_ de cuong service. This utility wraps <code>qlanphamdb.service.persistence.impl.AnPham_DeCuongPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author dnict
 * @see AnPham_DeCuongPersistence
 * @generated
 */
public class AnPham_DeCuongUtil {
	 ...
	 */
	public static void clearCache(AnPham_DeCuong anPham_DeCuong) {
		getPersistence().clearCache(anPham_DeCuong);
	}
	 ...
	 */
	public static Map<Serializable, AnPham_DeCuong> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AnPham_DeCuong> findWithDynamicQuery(
	 ...
	 */
	public static AnPham_DeCuong update(AnPham_DeCuong anPham_DeCuong) {
		return getPersistence().update(anPham_DeCuong);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static AnPham_DeCuong update(
		AnPham_DeCuong anPham_DeCuong, ServiceContext serviceContext) {

		return getPersistence().update(anPham_DeCuong, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(AnPham_DeCuong anPham_DeCuong) {
		getPersistence().cacheResult(anPham_DeCuong);
	}
	 ...
	 */
	public static void cacheResult(List<AnPham_DeCuong> anPham_DeCuongs) {
		getPersistence().cacheResult(anPham_DeCuongs);
	}
	 ...
	 */
	public static AnPham_DeCuong create(long id) {
	 ...
	 */
	public static AnPham_DeCuong remove(long id)
		throws qlanphamdb.exception.NoSuchAnPham_DeCuongException {

		return getPersistence().remove(id);
	}

	public static AnPham_DeCuong updateImpl(AnPham_DeCuong anPham_DeCuong) {
		return getPersistence().updateImpl(anPham_DeCuong);
	}
	 ...
	 * @throws NoSuchAnPham_DeCuongException if a an pham_ de cuong with the primary key could not be found
	 */
	public static AnPham_DeCuong findByPrimaryKey(long id)
		throws qlanphamdb.exception.NoSuchAnPham_DeCuongException {
	 ...
	 */
	public static AnPham_DeCuong fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<AnPham_DeCuong> findAll() {
	 ...
	 */
	public static List<AnPham_DeCuong> findAll(int start, int end) {
	...
	public static AnPham_DeCuongPersistence getPersistence() {
		return _persistence;
	}

	private static volatile AnPham_DeCuongPersistence _persistence;
