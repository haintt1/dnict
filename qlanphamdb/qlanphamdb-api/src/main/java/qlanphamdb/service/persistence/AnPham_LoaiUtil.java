...
/**
 * The persistence utility for the an pham_ loai service. This utility wraps <code>qlanphamdb.service.persistence.impl.AnPham_LoaiPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author dnict
 * @see AnPham_LoaiPersistence
 * @generated
 */
public class AnPham_LoaiUtil {
	 ...
	 */
	public static void clearCache(AnPham_Loai anPham_Loai) {
		getPersistence().clearCache(anPham_Loai);
	}
	 ...
	 */
	public static Map<Serializable, AnPham_Loai> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AnPham_Loai> findWithDynamicQuery(
	...
	public static List<AnPham_Loai> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<AnPham_Loai> orderByComparator) {
	 ...
	 */
	public static AnPham_Loai update(AnPham_Loai anPham_Loai) {
		return getPersistence().update(anPham_Loai);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static AnPham_Loai update(
		AnPham_Loai anPham_Loai, ServiceContext serviceContext) {

		return getPersistence().update(anPham_Loai, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(AnPham_Loai anPham_Loai) {
		getPersistence().cacheResult(anPham_Loai);
	}
	 ...
	 */
	public static void cacheResult(List<AnPham_Loai> anPham_Loais) {
		getPersistence().cacheResult(anPham_Loais);
	}
	 ...
	 */
	public static AnPham_Loai create(long id) {
	 ...
	 */
	public static AnPham_Loai remove(long id)
		throws qlanphamdb.exception.NoSuchAnPham_LoaiException {

		return getPersistence().remove(id);
	}

	public static AnPham_Loai updateImpl(AnPham_Loai anPham_Loai) {
		return getPersistence().updateImpl(anPham_Loai);
	}
	 ...
	 * @throws NoSuchAnPham_LoaiException if a an pham_ loai with the primary key could not be found
	 */
	public static AnPham_Loai findByPrimaryKey(long id)
		throws qlanphamdb.exception.NoSuchAnPham_LoaiException {
	 ...
	 */
	public static AnPham_Loai fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<AnPham_Loai> findAll() {
	 ...
	 */
	public static List<AnPham_Loai> findAll(int start, int end) {
	...
	public static AnPham_LoaiPersistence getPersistence() {
		return _persistence;
	}

	private static volatile AnPham_LoaiPersistence _persistence;
