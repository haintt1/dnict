...
/**
 * The persistence interface for the an pham_ loai service.
 *
 * <p>
 ...
 */
@ProviderType
public interface AnPham_LoaiPersistence extends BasePersistence<AnPham_Loai> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AnPham_LoaiUtil} to access the an pham_ loai persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<AnPham_Loai> anPham_Loais);
	 ...
	 */
	public java.util.List<AnPham_Loai> findAll();
	 ...
	 */
	public java.util.List<AnPham_Loai> findAll(int start, int end);
	...
	public java.util.List<AnPham_Loai> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AnPham_Loai>
			orderByComparator);
