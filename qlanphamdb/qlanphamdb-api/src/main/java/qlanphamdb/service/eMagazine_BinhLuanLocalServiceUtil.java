...
/**
 * Provides the local service utility for eMagazine_BinhLuan. This utility wraps
 * <code>qlanphamdb.service.impl.eMagazine_BinhLuanLocalServiceImpl</code> and
 ...
 * @generated
 */
public class eMagazine_BinhLuanLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>qlanphamdb.service.impl.eMagazine_BinhLuanLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static eMagazine_BinhLuan addeMagazine_BinhLuan(
		eMagazine_BinhLuan eMagazine_BinhLuan) {

		return getService().addeMagazine_BinhLuan(eMagazine_BinhLuan);
	}
	 ...
	 */
	public static eMagazine_BinhLuan createeMagazine_BinhLuan(long id) {
		return getService().createeMagazine_BinhLuan(id);
	}
	 ...
	 */
	public static eMagazine_BinhLuan deleteeMagazine_BinhLuan(
		eMagazine_BinhLuan eMagazine_BinhLuan) {

		return getService().deleteeMagazine_BinhLuan(eMagazine_BinhLuan);
	}
	 ...
	 */
	public static eMagazine_BinhLuan deleteeMagazine_BinhLuan(long id)
		throws PortalException {

		return getService().deleteeMagazine_BinhLuan(id);
	}
	...
	public static eMagazine_BinhLuan fetcheMagazine_BinhLuan(long id) {
		return getService().fetcheMagazine_BinhLuan(id);
	}
	 ...
	 * @throws PortalException if a e magazine_ binh luan with the primary key could not be found
	 */
	public static eMagazine_BinhLuan geteMagazine_BinhLuan(long id)
		throws PortalException {

		return getService().geteMagazine_BinhLuan(id);
	}
	 ...
	 */
	public static List<eMagazine_BinhLuan> geteMagazine_BinhLuans(
		int start, int end) {

		return getService().geteMagazine_BinhLuans(start, end);
	}
	 ...
	 */
	public static int geteMagazine_BinhLuansCount() {
		return getService().geteMagazine_BinhLuansCount();
	}
	 ...
	 */
	public static eMagazine_BinhLuan updateeMagazine_BinhLuan(
		eMagazine_BinhLuan eMagazine_BinhLuan) {

		return getService().updateeMagazine_BinhLuan(eMagazine_BinhLuan);
	}

	public static eMagazine_BinhLuanLocalService getService() {
		return _service;
	}

	private static volatile eMagazine_BinhLuanLocalService _service;
