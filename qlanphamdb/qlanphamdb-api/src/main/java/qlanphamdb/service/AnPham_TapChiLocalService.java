...
/**
 * Provides the local service interface for AnPham_TapChi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see AnPham_TapChiLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AnPham_TapChiLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>qlanphamdb.service.impl.AnPham_TapChiLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the an pham_ tap chi local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AnPham_TapChiLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AnPham_TapChi addAnPham_TapChi(AnPham_TapChi anPham_TapChi);
	...
	public AnPham_TapChi createAnPham_TapChi(long id);
	...
	public AnPham_TapChi deleteAnPham_TapChi(AnPham_TapChi anPham_TapChi);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AnPham_TapChi deleteAnPham_TapChi(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AnPham_TapChi fetchAnPham_TapChi(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AnPham_TapChi getAnPham_TapChi(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AnPham_TapChi> getAnPham_TapChis(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AnPham_TapChi updateAnPham_TapChi(AnPham_TapChi anPham_TapChi);
