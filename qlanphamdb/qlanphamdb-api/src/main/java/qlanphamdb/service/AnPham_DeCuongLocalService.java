...
/**
 * Provides the local service interface for AnPham_DeCuong. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see AnPham_DeCuongLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AnPham_DeCuongLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>qlanphamdb.service.impl.AnPham_DeCuongLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the an pham_ de cuong local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AnPham_DeCuongLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AnPham_DeCuong addAnPham_DeCuong(AnPham_DeCuong anPham_DeCuong);
	...
	public AnPham_DeCuong createAnPham_DeCuong(long id);
	...
	public AnPham_DeCuong deleteAnPham_DeCuong(AnPham_DeCuong anPham_DeCuong);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AnPham_DeCuong deleteAnPham_DeCuong(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AnPham_DeCuong fetchAnPham_DeCuong(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AnPham_DeCuong getAnPham_DeCuong(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AnPham_DeCuong> getAnPham_DeCuongs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AnPham_DeCuong updateAnPham_DeCuong(AnPham_DeCuong anPham_DeCuong);
