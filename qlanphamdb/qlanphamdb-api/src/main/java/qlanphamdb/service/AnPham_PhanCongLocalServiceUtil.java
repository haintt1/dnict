...
/**
 * Provides the local service utility for AnPham_PhanCong. This utility wraps
 * <code>qlanphamdb.service.impl.AnPham_PhanCongLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AnPham_PhanCongLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>qlanphamdb.service.impl.AnPham_PhanCongLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AnPham_PhanCong addAnPham_PhanCong(
		AnPham_PhanCong anPham_PhanCong) {

		return getService().addAnPham_PhanCong(anPham_PhanCong);
	}
	 ...
	 */
	public static AnPham_PhanCong createAnPham_PhanCong(long id) {
		return getService().createAnPham_PhanCong(id);
	}
	 ...
	 */
	public static AnPham_PhanCong deleteAnPham_PhanCong(
		AnPham_PhanCong anPham_PhanCong) {

		return getService().deleteAnPham_PhanCong(anPham_PhanCong);
	}
	 ...
	 */
	public static AnPham_PhanCong deleteAnPham_PhanCong(long id)
		throws PortalException {

		return getService().deleteAnPham_PhanCong(id);
	}
	...
	public static AnPham_PhanCong fetchAnPham_PhanCong(long id) {
		return getService().fetchAnPham_PhanCong(id);
	}
	 ...
	 * @throws PortalException if a an pham_ phan cong with the primary key could not be found
	 */
	public static AnPham_PhanCong getAnPham_PhanCong(long id)
		throws PortalException {

		return getService().getAnPham_PhanCong(id);
	}
	 ...
	 */
	public static List<AnPham_PhanCong> getAnPham_PhanCongs(
		int start, int end) {

		return getService().getAnPham_PhanCongs(start, end);
	}
	 ...
	 */
	public static int getAnPham_PhanCongsCount() {
		return getService().getAnPham_PhanCongsCount();
	}
	 ...
	 */
	public static AnPham_PhanCong updateAnPham_PhanCong(
		AnPham_PhanCong anPham_PhanCong) {

		return getService().updateAnPham_PhanCong(anPham_PhanCong);
	}

	public static AnPham_PhanCongLocalService getService() {
		return _service;
	}

	private static volatile AnPham_PhanCongLocalService _service;
