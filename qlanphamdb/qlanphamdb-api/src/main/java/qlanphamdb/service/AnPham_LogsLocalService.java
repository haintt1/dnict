...
/**
 * Provides the local service interface for AnPham_Logs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see AnPham_LogsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AnPham_LogsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>qlanphamdb.service.impl.AnPham_LogsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the an pham_ logs local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AnPham_LogsLocalServiceUtil} if injection and service tracking are not available.
	 */
