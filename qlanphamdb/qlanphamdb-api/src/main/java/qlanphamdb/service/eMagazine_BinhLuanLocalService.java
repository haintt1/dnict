...
/**
 * Provides the local service interface for eMagazine_BinhLuan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see eMagazine_BinhLuanLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface eMagazine_BinhLuanLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>qlanphamdb.service.impl.eMagazine_BinhLuanLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the e magazine_ binh luan local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link eMagazine_BinhLuanLocalServiceUtil} if injection and service tracking are not available.
	 */
