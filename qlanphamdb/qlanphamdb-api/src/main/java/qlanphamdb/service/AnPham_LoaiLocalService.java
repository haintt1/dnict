...
/**
 * Provides the local service interface for AnPham_Loai. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dnict
 * @see AnPham_LoaiLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AnPham_LoaiLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>qlanphamdb.service.impl.AnPham_LoaiLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the an pham_ loai local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AnPham_LoaiLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AnPham_Loai addAnPham_Loai(AnPham_Loai anPham_Loai);
	...
	public AnPham_Loai createAnPham_Loai(long id);
	...
	public AnPham_Loai deleteAnPham_Loai(AnPham_Loai anPham_Loai);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AnPham_Loai deleteAnPham_Loai(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AnPham_Loai fetchAnPham_Loai(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AnPham_Loai getAnPham_Loai(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AnPham_Loai> getAnPham_Loais(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AnPham_Loai updateAnPham_Loai(AnPham_Loai anPham_Loai);
