 ...
 */
@Deprecated
public class eMagazine_LogsSoap implements Serializable {

	public static eMagazine_LogsSoap toSoapModel(eMagazine_Logs model) {
		eMagazine_LogsSoap soapModel = new eMagazine_LogsSoap();
	...
	public static eMagazine_LogsSoap[] toSoapModels(eMagazine_Logs[] models) {
		eMagazine_LogsSoap[] soapModels = new eMagazine_LogsSoap[models.length];
	...
	public static eMagazine_LogsSoap[][] toSoapModels(
		eMagazine_Logs[][] models) {

		eMagazine_LogsSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels =
				new eMagazine_LogsSoap[models.length][models[0].length];
		}
		else {
			soapModels = new eMagazine_LogsSoap[0][0];
		}
	...
	public static eMagazine_LogsSoap[] toSoapModels(
		List<eMagazine_Logs> models) {

		List<eMagazine_LogsSoap> soapModels = new ArrayList<eMagazine_LogsSoap>(
			models.size());

		for (eMagazine_Logs model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new eMagazine_LogsSoap[soapModels.size()]);
	}

	public eMagazine_LogsSoap() {
	}
