...
/**
 * The base model interface for the AnPham_Logs service. Represents a row in the &quot;cw_AnPham_Logs&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>qlanphamdb.model.impl.AnPham_LogsModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>qlanphamdb.model.impl.AnPham_LogsImpl</code>.
 * </p>
 *
 * @author dnict
 * @see AnPham_Logs
 ...
 */
@ProviderType
public interface AnPham_LogsModel extends BaseModel<AnPham_Logs>, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a an pham_ logs model instance should use the {@link AnPham_Logs} interface instead.
	 */
