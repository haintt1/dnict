 ...
 */
@Deprecated
public class AnPham_TapChiSoap implements Serializable {

	public static AnPham_TapChiSoap toSoapModel(AnPham_TapChi model) {
		AnPham_TapChiSoap soapModel = new AnPham_TapChiSoap();
	...
	public static AnPham_TapChiSoap[] toSoapModels(AnPham_TapChi[] models) {
		AnPham_TapChiSoap[] soapModels = new AnPham_TapChiSoap[models.length];
	...
	public static AnPham_TapChiSoap[][] toSoapModels(AnPham_TapChi[][] models) {
		AnPham_TapChiSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new AnPham_TapChiSoap[models.length][models[0].length];
		}
		else {
			soapModels = new AnPham_TapChiSoap[0][0];
		}
	...
	public static AnPham_TapChiSoap[] toSoapModels(List<AnPham_TapChi> models) {
		List<AnPham_TapChiSoap> soapModels = new ArrayList<AnPham_TapChiSoap>(
			models.size());

		for (AnPham_TapChi model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new AnPham_TapChiSoap[soapModels.size()]);
	}

	public AnPham_TapChiSoap() {
	}
