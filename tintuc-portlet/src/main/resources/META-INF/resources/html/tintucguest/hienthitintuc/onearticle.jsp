...
String idnews = prefs.getValue("idarticle", StringPool.BLANK);
//String idnews = "1102";
//System.out.print("idnews: "+idnews);
	...
	<%if(Validator.isNotNull(news_article)){%>
			<article class="the-article">
				...
				<section class="main-article">
					<div class="title-article" id="title-article">
					...
					<div class="author-createtime-viewcount">
						...
						<%
							...
							//System.out.println(news_article.getLuotxem());
						%><%=dem%></span>
					...
					<%} %>
						...
						<script src="https://code.responsivevoice.org/responsivevoice.js?key=BBT8ELyQ"></script>
	 					<script>
/* 	 					$("#title-article").click(function(){
	 						var title = document.getElementById("title-article").textContent;
							var titleHtml = title.replace(/(\r?\n|\r\t)/gm, ' ');
							responsiveVoice.cancel();
							responsiveVoice.speak(titleHtml,'Vietnamese Male');
						...
						playbutton.onclick = function() {
							...
							var title = document.getElementById("title-article").textContent;
							var tieude = title.replace(/(\r?\n|\r)/gm, ' ');
							var trims = contentHTML.replace(/(\r?\n|\r)/gm, ' ');
							var noidung = tieude + trims;
							//alert(noidung);
							  responsiveVoice.cancel();
							  responsiveVoice.speak(noidung,'Vietnamese Male');
					...
					if(responsiveVoice.voiceSupport()) {
					  ...
					  responsiveVoice.speak("Chủ tịch Hồ Chí Minh", "Vietnamese Male");
					};
						...
						//new SpeechSynthesisUtterance object
 						...
 						//utter.lang = 'ja_JP';
 						//utter.text = "Vào 19h ngày 22/5, U23 Việt Nam sẽ bước vào trận chung kết SEA Games 31 gặp U23 Thái Lan trên sân Mỹ Đình";
 						//utter.volume = 0.5;
...
<!-- 							</a> -->
						...
						<a class="the-article-goback" href="javascript:history.go(-1);"><img src="<%=request.getContextPath()%>/images/icon_active/backicon.png"></a>
					</div>
					<%
					...
					<ul class="cat-lienquan">
						...
						<li>
							<%
								...
								//System.out.print("So tin lien quan: "+ sotinhienthilienquan);
							%>
					...
					<div class="the-article-more-info">
						<ul>
							...
							if(listarticle2Category.size()>0){
								...
								List<News_Article> more_article = TinTucAdminUtil.listarticlbydate(news_article.getCreatedtime(), Integer.valueOf(10), listcategory);
			...
			<script type="text/javascript">
				function changeFont(multiplier) {
					if (multiplier==0){
						jQuery('.main-article').find("span,p,div,strong").css('font-size','15px');
					}else{
