...
/**
 * Provides the local service utility for News_role. This utility wraps
 * <code>vn.dnict.tintuc.service.impl.News_roleLocalServiceImpl</code> and
 ...
 * @generated
 */
public class News_roleLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>vn.dnict.tintuc.service.impl.News_roleLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static News_role addNews_role(News_role news_role) {
		return getService().addNews_role(news_role);
	}
	 ...
	 */
	public static News_role createNews_role(long id) {
		return getService().createNews_role(id);
	}
	 ...
	 */
	public static News_role deleteNews_role(long id) throws PortalException {
		return getService().deleteNews_role(id);
	}
	 ...
	 * @return the news_role that was removed
	 */
	public static News_role deleteNews_role(News_role news_role) {
		return getService().deleteNews_role(news_role);
	}
	...
	public static News_role fetchNews_role(long id) {
		return getService().fetchNews_role(id);
	}
	 ...
	 * @throws PortalException if a news_role with the primary key could not be found
	 */
	public static News_role getNews_role(long id) throws PortalException {
		return getService().getNews_role(id);
	}
	 ...
	 */
	public static List<News_role> getNews_roles(int start, int end) {
		return getService().getNews_roles(start, end);
	}
	 ...
	 */
	public static int getNews_rolesCount() {
		return getService().getNews_rolesCount();
	}
	 ...
	 */
	public static News_role updateNews_role(News_role news_role) {
		return getService().updateNews_role(news_role);
	}

	public static News_roleLocalService getService() {
		return _service;
	}

	private static volatile News_roleLocalService _service;
