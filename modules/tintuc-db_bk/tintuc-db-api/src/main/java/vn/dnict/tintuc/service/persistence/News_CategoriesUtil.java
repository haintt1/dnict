...
/**
 * The persistence utility for the news_ categories service. This utility wraps <code>vn.dnict.tintuc.service.persistence.impl.News_CategoriesPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author dnict
 * @see News_CategoriesPersistence
 * @generated
 */
public class News_CategoriesUtil {
	 ...
	 */
	public static void clearCache(News_Categories news_Categories) {
		getPersistence().clearCache(news_Categories);
	}
	 ...
	 */
	public static Map<Serializable, News_Categories> fetchByPrimaryKeys(
	 ...
	 */
	public static List<News_Categories> findWithDynamicQuery(
	 ...
	 */
	public static News_Categories update(News_Categories news_Categories) {
		return getPersistence().update(news_Categories);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static News_Categories update(
		News_Categories news_Categories, ServiceContext serviceContext) {

		return getPersistence().update(news_Categories, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(News_Categories news_Categories) {
		getPersistence().cacheResult(news_Categories);
	}
	 ...
	 */
	public static void cacheResult(List<News_Categories> news_Categorieses) {
		getPersistence().cacheResult(news_Categorieses);
	}
	 ...
	 */
	public static News_Categories create(long id) {
	 ...
	 */
	public static News_Categories remove(long id)
		throws vn.dnict.tintuc.exception.NoSuchNews_CategoriesException {

		return getPersistence().remove(id);
	}

	public static News_Categories updateImpl(News_Categories news_Categories) {
		return getPersistence().updateImpl(news_Categories);
	}
	 ...
	 * @throws NoSuchNews_CategoriesException if a news_ categories with the primary key could not be found
	 */
	public static News_Categories findByPrimaryKey(long id)
		throws vn.dnict.tintuc.exception.NoSuchNews_CategoriesException {
	 ...
	 */
	public static News_Categories fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<News_Categories> findAll() {
	 ...
	 */
	public static List<News_Categories> findAll(int start, int end) {
	...
	public static News_CategoriesPersistence getPersistence() {
		return _persistence;
	}

	private static volatile News_CategoriesPersistence _persistence;
