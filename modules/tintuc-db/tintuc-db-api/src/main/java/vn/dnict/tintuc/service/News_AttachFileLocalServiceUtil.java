...
/**
 * Provides the local service utility for News_AttachFile. This utility wraps
 * <code>vn.dnict.tintuc.service.impl.News_AttachFileLocalServiceImpl</code> and
 ...
 * @generated
 */
public class News_AttachFileLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>vn.dnict.tintuc.service.impl.News_AttachFileLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static News_AttachFile addNews_AttachFile(
		News_AttachFile news_AttachFile) {

		return getService().addNews_AttachFile(news_AttachFile);
	}
	 ...
	 */
	public static News_AttachFile createNews_AttachFile(long id) {
		return getService().createNews_AttachFile(id);
	}
	 ...
	 */
	public static News_AttachFile deleteNews_AttachFile(long id)
		throws PortalException {

		return getService().deleteNews_AttachFile(id);
	}
	 ...
	 * @return the news_ attach file that was removed
	 */
	public static News_AttachFile deleteNews_AttachFile(
		News_AttachFile news_AttachFile) {

		return getService().deleteNews_AttachFile(news_AttachFile);
	}
	...
	public static News_AttachFile fetchNews_AttachFile(long id) {
		return getService().fetchNews_AttachFile(id);
	}
	 ...
	 * @throws PortalException if a news_ attach file with the primary key could not be found
	 */
	public static News_AttachFile getNews_AttachFile(long id)
		throws PortalException {

		return getService().getNews_AttachFile(id);
	}
	 ...
	 */
	public static List<News_AttachFile> getNews_AttachFiles(
		int start, int end) {

		return getService().getNews_AttachFiles(start, end);
	}
	 ...
	 */
	public static int getNews_AttachFilesCount() {
		return getService().getNews_AttachFilesCount();
	}

	public static List<News_AttachFile> getObjectId(long objectId) {
	 ...
	 */
	public static News_AttachFile updateNews_AttachFile(
		News_AttachFile news_AttachFile) {

		return getService().updateNews_AttachFile(news_AttachFile);
	}

	public static News_AttachFileLocalService getService() {
		return _service;
	}

	private static volatile News_AttachFileLocalService _service;
