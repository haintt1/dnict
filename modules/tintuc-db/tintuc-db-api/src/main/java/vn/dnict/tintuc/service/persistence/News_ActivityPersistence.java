...
/**
 * The persistence interface for the news_ activity service.
 *
 * <p>
 ...
 *
 * @author dnict
 * @see News_ActivityUtil
 * @generated
 */
@ProviderType
public interface News_ActivityPersistence
	extends BasePersistence<News_Activity> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link News_ActivityUtil} to access the news_ activity persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<News_Activity> news_Activities);
	 ...
	 */
	public java.util.List<News_Activity> findAll();
	 ...
	 */
	public java.util.List<News_Activity> findAll(int start, int end);
	...
	public java.util.List<News_Activity> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<News_Activity>
			orderByComparator);
