...
public class News_AttachFileUtil {
	 ...
	 */
	public static List<News_AttachFile> findByObjectId(long ObjectId) {
	 ...
	 */
	public static List<News_AttachFile> findByObjectId(
	 ...
	 */
	public static News_AttachFile findByObjectId_First(
	 ...
	 */
	public static News_AttachFile fetchByObjectId_First(
		long ObjectId, OrderByComparator<News_AttachFile> orderByComparator) {
	 ...
	 * @throws NoSuchNews_AttachFileException if a matching news_ attach file could not be found
	 */
	public static News_AttachFile findByObjectId_Last(
			long ObjectId, OrderByComparator<News_AttachFile> orderByComparator)
		throws vn.dnict.tintuc.exception.NoSuchNews_AttachFileException {
	 ...
	 */
	public static News_AttachFile fetchByObjectId_Last(
		long ObjectId, OrderByComparator<News_AttachFile> orderByComparator) {
	 ...
	 */
	public static News_AttachFile[] findByObjectId_PrevAndNext(
