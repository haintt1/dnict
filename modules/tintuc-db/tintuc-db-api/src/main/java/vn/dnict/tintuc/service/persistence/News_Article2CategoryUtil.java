...
public class News_Article2CategoryUtil {
	 ...
	 */
	public static List<News_Article2Category> findBynewarticleId(
		long newarticleId) {

		return getPersistence().findBynewarticleId(newarticleId);
	}
	...
	public static List<News_Article2Category> findBynewarticleId(
		...
		return getPersistence().findBynewarticleId(newarticleId, start, end);
	}
	...
	public static List<News_Article2Category> findBynewarticleId(
		...
		return getPersistence().findBynewarticleId(
	...
	public static List<News_Article2Category> findBynewarticleId(
		...
		return getPersistence().findBynewarticleId(
			newarticleId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 */
	public static News_Article2Category findBynewarticleId_First(
			long newarticleId,
			OrderByComparator<News_Article2Category> orderByComparator)
		throws vn.dnict.tintuc.exception.NoSuchNews_Article2CategoryException {

		return getPersistence().findBynewarticleId_First(
	 ...
	 */
	public static News_Article2Category fetchBynewarticleId_First(
		long newarticleId,
		OrderByComparator<News_Article2Category> orderByComparator) {

		return getPersistence().fetchBynewarticleId_First(
			newarticleId, orderByComparator);
	}
	 ...
	 * @throws NoSuchNews_Article2CategoryException if a matching news_ article2 category could not be found
	 */
	public static News_Article2Category findBynewarticleId_Last(
			long newarticleId,
			OrderByComparator<News_Article2Category> orderByComparator)
		throws vn.dnict.tintuc.exception.NoSuchNews_Article2CategoryException {

		return getPersistence().findBynewarticleId_Last(
			newarticleId, orderByComparator);
	}
	 ...
	 */
	public static News_Article2Category fetchBynewarticleId_Last(
		long newarticleId,
		OrderByComparator<News_Article2Category> orderByComparator) {

		return getPersistence().fetchBynewarticleId_Last(
			newarticleId, orderByComparator);
	}
	 ...
	 */
	public static News_Article2Category[] findBynewarticleId_PrevAndNext(
			long id, long newarticleId,
			OrderByComparator<News_Article2Category> orderByComparator)
		throws vn.dnict.tintuc.exception.NoSuchNews_Article2CategoryException {

		return getPersistence().findBynewarticleId_PrevAndNext(
			id, newarticleId, orderByComparator);
	}
	 ...
	 * @param newarticleId the newarticle ID
	 */
	public static void removeBynewarticleId(long newarticleId) {
		getPersistence().removeBynewarticleId(newarticleId);
	}
	 ...
	 */
	public static int countBynewarticleId(long newarticleId) {
		return getPersistence().countBynewarticleId(newarticleId);
	}
