...
public class News_AttachFilePersistenceImpl
	...
	/**
	 * Returns all the news_ attach files where ObjectId = &#63;.
	 *
	 * @param ObjectId the object ID
	 * @return the matching news_ attach files
	 */
	@Override
	public List<News_AttachFile> findByObjectId(long ObjectId) {
		return findByObjectId(
			ObjectId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the news_ attach files where ObjectId = &#63;.
	 *
	 * <p>
	 ...
	 * @return the range of matching news_ attach files
	 */
	@Override
	public List<News_AttachFile> findByObjectId(
	...
	/**
	 * Returns an ordered range of all the news_ attach files where ObjectId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>News_AttachFileModelImpl</code>.
	 * </p>
	 ...
	 * @return the ordered range of matching news_ attach files
	 */
	@Override
	public List<News_AttachFile> findByObjectId(
		long ObjectId, int start, int end,
	...
	public List<News_AttachFile> findByObjectId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (News_AttachFile news_AttachFile : list) {
					if (ObjectId != news_AttachFile.getObjectId()) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_NEWS_ATTACHFILE_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(News_AttachFileModelImpl.ORDER_BY_JPQL);
			}
	...
	/**
	 * Returns the first news_ attach file in the ordered set where ObjectId = &#63;.
	 *
	 * @param ObjectId the object ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching news_ attach file
	 * @throws NoSuchNews_AttachFileException if a matching news_ attach file could not be found
	 */
	@Override
	public News_AttachFile findByObjectId_First(
			long ObjectId, OrderByComparator<News_AttachFile> orderByComparator)
		throws NoSuchNews_AttachFileException {

		News_AttachFile news_AttachFile = fetchByObjectId_First(
		...
		throw new NoSuchNews_AttachFileException(sb.toString());
	}
	 ...
	 * @param ObjectId the object ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching news_ attach file, or <code>null</code> if a matching news_ attach file could not be found
	 */
	@Override
	public News_AttachFile fetchByObjectId_First(
		long ObjectId, OrderByComparator<News_AttachFile> orderByComparator) {

		List<News_AttachFile> list = findByObjectId(
			ObjectId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last news_ attach file in the ordered set where ObjectId = &#63;.
	 *
	 * @param ObjectId the object ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching news_ attach file
	 * @throws NoSuchNews_AttachFileException if a matching news_ attach file could not be found
	 */
	@Override
	public News_AttachFile findByObjectId_Last(
			long ObjectId, OrderByComparator<News_AttachFile> orderByComparator)
		throws NoSuchNews_AttachFileException {

		News_AttachFile news_AttachFile = fetchByObjectId_Last(
			ObjectId, orderByComparator);
	 ...
	 * @param ObjectId the object ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching news_ attach file, or <code>null</code> if a matching news_ attach file could not be found
	 */
	@Override
	public News_AttachFile fetchByObjectId_Last(
		long ObjectId, OrderByComparator<News_AttachFile> orderByComparator) {
	...
	/**
	 * Returns the news_ attach files before and after the current news_ attach file in the ordered set where ObjectId = &#63;.
	 *
	 * @param id the primary key of the current news_ attach file
	 * @param ObjectId the object ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the previous, current, and next news_ attach file
	 * @throws NoSuchNews_AttachFileException if a news_ attach file with the primary key could not be found
	 */
	@Override
	public News_AttachFile[] findByObjectId_PrevAndNext(
			long id, long ObjectId,
			OrderByComparator<News_AttachFile> orderByComparator)
		throws NoSuchNews_AttachFileException {

		News_AttachFile news_AttachFile = findByPrimaryKey(id);
		...
		try {
			...
			News_AttachFile[] array = new News_AttachFileImpl[3];

			array[0] = getByObjectId_PrevAndNext(
				session, news_AttachFile, ObjectId, orderByComparator, true);

			array[1] = news_AttachFile;

			array[2] = getByObjectId_PrevAndNext(
				session, news_AttachFile, ObjectId, orderByComparator, false);
	...
	protected News_AttachFile getByObjectId_PrevAndNext(
		Session session, News_AttachFile news_AttachFile, long ObjectId,
		OrderByComparator<News_AttachFile> orderByComparator,
		boolean previous) {
		...
		List<News_AttachFile> list = query.list();
	...
	/**
	 * Removes all the news_ attach files where ObjectId = &#63; from the database.
	 *
	 * @param ObjectId the object ID
	 */
	@Override
	public void removeByObjectId(long ObjectId) {
		for (News_AttachFile news_AttachFile :
				findByObjectId(
					ObjectId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	/**
	 * Returns the number of news_ attach files where ObjectId = &#63;.
	 *
	 * @param ObjectId the object ID
	 * @return the number of matching news_ attach files
	 */
	@Override
	public int countByObjectId(long ObjectId) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_NEWS_ATTACHFILE_WHERE);
	...
	public News_AttachFile updateImpl(News_AttachFile news_AttachFile) {
		...
		if (!(news_AttachFile instanceof News_AttachFileModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(news_AttachFile.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					news_AttachFile);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in news_AttachFile proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom News_AttachFile implementation " +
					news_AttachFile.getClass());
		}

		News_AttachFileModelImpl news_AttachFileModelImpl =
			(News_AttachFileModelImpl)news_AttachFile;
		...
		entityCache.putResult(
			News_AttachFileImpl.class, news_AttachFileModelImpl, false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByObjectId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByObjectId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"ObjectId"}, true);

		_finderPathWithoutPaginationFindByObjectId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByObjectId",
			new String[] {Long.class.getName()}, new String[] {"ObjectId"},
			true);

		_finderPathCountByObjectId = _createFinderPath(
	...
	private static final String _SQL_SELECT_NEWS_ATTACHFILE_WHERE =
		"SELECT news_AttachFile FROM News_AttachFile news_AttachFile WHERE ";

	private static final String _SQL_COUNT_NEWS_ATTACHFILE =
		"SELECT COUNT(news_AttachFile) FROM News_AttachFile news_AttachFile";

	private static final String _SQL_COUNT_NEWS_ATTACHFILE_WHERE =
		"SELECT COUNT(news_AttachFile) FROM News_AttachFile news_AttachFile WHERE ";
	...
	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No News_AttachFile exists with the key {";
