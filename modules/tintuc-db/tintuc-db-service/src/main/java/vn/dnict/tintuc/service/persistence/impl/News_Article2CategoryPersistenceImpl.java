...
public class News_Article2CategoryPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindBynewarticleId;
	private FinderPath _finderPathWithoutPaginationFindBynewarticleId;
	private FinderPath _finderPathCountBynewarticleId;

	/**
	 * Returns all the news_ article2 categories where newarticleId = &#63;.
	 *
	 * @param newarticleId the newarticle ID
	 * @return the matching news_ article2 categories
	 */
	@Override
	public List<News_Article2Category> findBynewarticleId(long newarticleId) {
		return findBynewarticleId(
			newarticleId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the news_ article2 categories where newarticleId = &#63;.
	 *
	 * <p>
	 ...
	 * @return the range of matching news_ article2 categories
	 */
	@Override
	public List<News_Article2Category> findBynewarticleId(
		long newarticleId, int start, int end) {

		return findBynewarticleId(newarticleId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the news_ article2 categories where newarticleId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>News_Article2CategoryModelImpl</code>.
	 * </p>
	 ...
	 * @return the ordered range of matching news_ article2 categories
	 */
	@Override
	public List<News_Article2Category> findBynewarticleId(
		long newarticleId, int start, int end,
		...
		return findBynewarticleId(
			newarticleId, start, end, orderByComparator, true);
	}
	...
	public List<News_Article2Category> findBynewarticleId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindBynewarticleId;
				finderArgs = new Object[] {newarticleId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBynewarticleId;
			finderArgs = new Object[] {
				newarticleId, start, end, orderByComparator
			};
		}
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (News_Article2Category news_Article2Category : list) {
					if (newarticleId !=
							news_Article2Category.getNewarticleId()) {
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_NEWS_ARTICLE2CATEGORY_WHERE);

			sb.append(_FINDER_COLUMN_NEWARTICLEID_NEWARTICLEID_2);
			...
			if (orderByComparator != null) {
				...
				sb.append(News_Article2CategoryModelImpl.ORDER_BY_JPQL);
			}
	...
	/**
	 * Returns the first news_ article2 category in the ordered set where newarticleId = &#63;.
	 *
	 * @param newarticleId the newarticle ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching news_ article2 category
	 * @throws NoSuchNews_Article2CategoryException if a matching news_ article2 category could not be found
	 */
	@Override
	public News_Article2Category findBynewarticleId_First(
			long newarticleId,
			OrderByComparator<News_Article2Category> orderByComparator)
		throws NoSuchNews_Article2CategoryException {

		News_Article2Category news_Article2Category = fetchBynewarticleId_First(
			newarticleId, orderByComparator);
		...
		throw new NoSuchNews_Article2CategoryException(sb.toString());
	}
	 ...
	 * @param newarticleId the newarticle ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching news_ article2 category, or <code>null</code> if a matching news_ article2 category could not be found
	 */
	@Override
	public News_Article2Category fetchBynewarticleId_First(
		long newarticleId,
		OrderByComparator<News_Article2Category> orderByComparator) {

		List<News_Article2Category> list = findBynewarticleId(
			newarticleId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last news_ article2 category in the ordered set where newarticleId = &#63;.
	 *
	 * @param newarticleId the newarticle ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching news_ article2 category
	 * @throws NoSuchNews_Article2CategoryException if a matching news_ article2 category could not be found
	 */
	@Override
	public News_Article2Category findBynewarticleId_Last(
			long newarticleId,
			OrderByComparator<News_Article2Category> orderByComparator)
		throws NoSuchNews_Article2CategoryException {

		News_Article2Category news_Article2Category = fetchBynewarticleId_Last(
			newarticleId, orderByComparator);
	 ...
	 * @param newarticleId the newarticle ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching news_ article2 category, or <code>null</code> if a matching news_ article2 category could not be found
	 */
	@Override
	public News_Article2Category fetchBynewarticleId_Last(
		long newarticleId,
		OrderByComparator<News_Article2Category> orderByComparator) {

		int count = countBynewarticleId(newarticleId);
		...
		List<News_Article2Category> list = findBynewarticleId(
			newarticleId, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the news_ article2 categories before and after the current news_ article2 category in the ordered set where newarticleId = &#63;.
	 *
	 * @param id the primary key of the current news_ article2 category
	 * @param newarticleId the newarticle ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the previous, current, and next news_ article2 category
	 * @throws NoSuchNews_Article2CategoryException if a news_ article2 category with the primary key could not be found
	 */
	@Override
	public News_Article2Category[] findBynewarticleId_PrevAndNext(
			long id, long newarticleId,
			OrderByComparator<News_Article2Category> orderByComparator)
		throws NoSuchNews_Article2CategoryException {

		News_Article2Category news_Article2Category = findByPrimaryKey(id);
		...
		try {
			...
			News_Article2Category[] array = new News_Article2CategoryImpl[3];

			array[0] = getBynewarticleId_PrevAndNext(
				session, news_Article2Category, newarticleId, orderByComparator,
				true);

			array[1] = news_Article2Category;

			array[2] = getBynewarticleId_PrevAndNext(
				session, news_Article2Category, newarticleId, orderByComparator,
				false);
	...
	protected News_Article2Category getBynewarticleId_PrevAndNext(
		Session session, News_Article2Category news_Article2Category,
		long newarticleId,
		OrderByComparator<News_Article2Category> orderByComparator,
		boolean previous) {
		...
		List<News_Article2Category> list = query.list();
	...
	/**
	 * Removes all the news_ article2 categories where newarticleId = &#63; from the database.
	 *
	 * @param newarticleId the newarticle ID
	 */
	@Override
	public void removeBynewarticleId(long newarticleId) {
	...
	/**
	 * Returns the number of news_ article2 categories where newarticleId = &#63;.
	 *
	 * @param newarticleId the newarticle ID
	 * @return the number of matching news_ article2 categories
	 */
	@Override
	public int countBynewarticleId(long newarticleId) {
		FinderPath finderPath = _finderPathCountBynewarticleId;

		Object[] finderArgs = new Object[] {newarticleId};
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_NEWS_ARTICLE2CATEGORY_WHERE);
	...
	private static final String _FINDER_COLUMN_NEWARTICLEID_NEWARTICLEID_2 =
		"news_Article2Category.newarticleId = ?";
	...
	public News_Article2Category updateImpl(
		...
		if (!(news_Article2Category instanceof
				News_Article2CategoryModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(news_Article2Category.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					news_Article2Category);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in news_Article2Category proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom News_Article2Category implementation " +
					news_Article2Category.getClass());
		}

		News_Article2CategoryModelImpl news_Article2CategoryModelImpl =
			(News_Article2CategoryModelImpl)news_Article2Category;
		...
		entityCache.putResult(
			News_Article2CategoryImpl.class, news_Article2CategoryModelImpl,
			false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindBynewarticleId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBynewarticleId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"newarticleId"}, true);

		_finderPathWithoutPaginationFindBynewarticleId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBynewarticleId",
			new String[] {Long.class.getName()}, new String[] {"newarticleId"},
			true);

		_finderPathCountBynewarticleId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBynewarticleId",
			new String[] {Long.class.getName()}, new String[] {"newarticleId"},
			false);
	...
	private static final String _SQL_SELECT_NEWS_ARTICLE2CATEGORY_WHERE =
		"SELECT news_Article2Category FROM News_Article2Category news_Article2Category WHERE ";
	...
	private static final String _SQL_COUNT_NEWS_ARTICLE2CATEGORY_WHERE =
		"SELECT COUNT(news_Article2Category) FROM News_Article2Category news_Article2Category WHERE ";
	...
	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No News_Article2Category exists with the key {";
