...
import vn.dnict.vanbanphapquy.model.impl.LoaivanbanImpl;
import vn.dnict.vanbanphapquy.model.impl.LoaivanbanModelImpl;
 ...
 * @generated
 */
@Component(service = LoaivanbanPersistence.class)
public class LoaivanbanPersistenceImpl
	extends BasePersistenceImpl<Loaivanban> implements LoaivanbanPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>LoaivanbanUtil</code> to access the loaivanban persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		LoaivanbanImpl.class.getName();
	 ...
	 */
	@Override
	public List<Loaivanban> findByStatus(int status) {
	 ...
	 */
	@Override
	public List<Loaivanban> findByStatus(int status, int start, int end) {
	 ...
	 */
	@Override
	public List<Loaivanban> findByStatus(
		int status, int start, int end,
		OrderByComparator<Loaivanban> orderByComparator) {
	...
	public List<Loaivanban> findByStatus(
		...
		List<Loaivanban> list = null;

		if (useFinderCache) {
			list = (List<Loaivanban>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (Loaivanban loaivanban : list) {
					if (status != loaivanban.getStatus()) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_LOAIVANBAN_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(LoaivanbanModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<Loaivanban>)QueryUtil.list(
	...
	public Loaivanban findByStatus_First(
			int status, OrderByComparator<Loaivanban> orderByComparator)
		throws NoSuchLoaivanbanException {

		Loaivanban loaivanban = fetchByStatus_First(status, orderByComparator);
		...
		throw new NoSuchLoaivanbanException(sb.toString());
	}
	...
	public Loaivanban fetchByStatus_First(
		...
		List<Loaivanban> list = findByStatus(status, 0, 1, orderByComparator);
	...
	public Loaivanban findByStatus_Last(
		...
		Loaivanban loaivanban = fetchByStatus_Last(status, orderByComparator);
	...
	public Loaivanban fetchByStatus_Last(
		...
		List<Loaivanban> list = findByStatus(
	...
	public Loaivanban[] findByStatus_PrevAndNext(
		...
		try {
			...
			array[0] = getByStatus_PrevAndNext(
				session, loaivanban, status, orderByComparator, true);

			array[1] = loaivanban;

			array[2] = getByStatus_PrevAndNext(
				session, loaivanban, status, orderByComparator, false);
	...
	protected Loaivanban getByStatus_PrevAndNext(
		Session session, Loaivanban loaivanban, int status,
		OrderByComparator<Loaivanban> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(loaivanban)) {

				queryPos.add(orderByConditionValue);
			}
		}

		List<Loaivanban> list = query.list();
	...
	public int countByStatus(int status) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_LOAIVANBAN_WHERE);
	...
	public LoaivanbanPersistenceImpl() {
		...
		setModelImplClass(LoaivanbanImpl.class);
	...
	public void cacheResult(List<Loaivanban> loaivanbans) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (loaivanbans.size() > _valueObjectFinderCacheListThreshold))) {
	...
	public void clearCache() {
		entityCache.clearCache(LoaivanbanImpl.class);
	...
	public void clearCache(Loaivanban loaivanban) {
		entityCache.removeResult(LoaivanbanImpl.class, loaivanban);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(LoaivanbanImpl.class, primaryKey);
		}
	}
	...
	public Loaivanban create(long id) {
		...
		loaivanban.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public Loaivanban remove(Serializable primaryKey)
		...
		try {
			...
			Loaivanban loaivanban = (Loaivanban)session.get(
		...
		catch (NoSuchLoaivanbanException noSuchEntityException) {
	...
	protected Loaivanban removeImpl(Loaivanban loaivanban) {
		...
		try {
			...
			if (!session.contains(loaivanban)) {
				loaivanban = (Loaivanban)session.get(
					LoaivanbanImpl.class, loaivanban.getPrimaryKeyObj());
			}
	...
	public Loaivanban updateImpl(Loaivanban loaivanban) {
		...
		if (!(loaivanban instanceof LoaivanbanModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(loaivanban.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(loaivanban);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in loaivanban proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom Loaivanban implementation " +
					loaivanban.getClass());
		}

		LoaivanbanModelImpl loaivanbanModelImpl =
			(LoaivanbanModelImpl)loaivanban;
		...
		try {
			...
			if (isNew) {
				...
				loaivanban = (Loaivanban)session.merge(loaivanban);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		entityCache.putResult(
			LoaivanbanImpl.class, loaivanbanModelImpl, false, true);
	...
	/**
	 * Returns the loaivanban with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the loaivanban
	 ...
	 */
	@Override
	public List<Loaivanban> findAll() {
	...
	@Override
	public List<Loaivanban> findAll(
		int start, int end, OrderByComparator<Loaivanban> orderByComparator) {
	...
	public List<Loaivanban> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_LOAIVANBAN);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_LOAIVANBAN);
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_LOAIVANBAN;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return LoaivanbanModelImpl.TABLE_COLUMNS_MAP;
	}
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new LoaivanbanModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", Loaivanban.class.getName()));
		...
		_setLoaivanbanUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setLoaivanbanUtilPersistence(null);

		entityCache.removeCache(LoaivanbanImpl.class.getName());
	...
	private void _setLoaivanbanUtilPersistence(
		LoaivanbanPersistence loaivanbanPersistence) {

		try {
			Field field = LoaivanbanUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, loaivanbanPersistence);
		}
	...
	private static final String _SQL_SELECT_LOAIVANBAN =
		"SELECT loaivanban FROM Loaivanban loaivanban";

	private static final String _SQL_SELECT_LOAIVANBAN_WHERE =
		"SELECT loaivanban FROM Loaivanban loaivanban WHERE ";

	private static final String _SQL_COUNT_LOAIVANBAN =
		"SELECT COUNT(loaivanban) FROM Loaivanban loaivanban";

	private static final String _SQL_COUNT_LOAIVANBAN_WHERE =
		"SELECT COUNT(loaivanban) FROM Loaivanban loaivanban WHERE ";
	...
	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No Loaivanban exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		LoaivanbanPersistenceImpl.class);
	...
	private static class LoaivanbanModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			LoaivanbanModelImpl loaivanbanModelImpl =
				(LoaivanbanModelImpl)baseModel;

			long columnBitmask = loaivanbanModelImpl.getColumnBitmask();

			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(loaivanbanModelImpl, columnNames, original);
			}
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |=
						loaivanbanModelImpl.getColumnBitmask(columnName);
				}

				if (finderPath.isBaseModelResult() &&
					(LoaivanbanPersistenceImpl.
		...
		private static Object[] _getValue(
			LoaivanbanModelImpl loaivanbanModelImpl, String[] columnNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = loaivanbanModelImpl.getColumnOriginalValue(
						columnName);
				}
				else {
					arguments[i] = loaivanbanModelImpl.getColumnValue(
						columnName);
				}
			}
