...
import vn.dnict.vanbanphapquy.service.LinhvucvanbanLocalService;
...
/**
 * Provides the base implementation for the linhvucvanban local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dnict.vanbanphapquy.service.impl.LinhvucvanbanLocalServiceImpl}.
 * </p>
 *
 * @author BinhNT
 * @see vn.dnict.vanbanphapquy.service.impl.LinhvucvanbanLocalServiceImpl
 * @generated
 */
public abstract class LinhvucvanbanLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LinhvucvanbanLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LinhvucvanbanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LinhvucvanbanLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Linhvucvanban.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return linhvucvanbanPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return linhvucvanbanPersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(linhvucvanbanLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Linhvucvanban.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Linhvucvanban.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return linhvucvanbanPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return linhvucvanbanLocalService.deleteLinhvucvanban(
			(Linhvucvanban)persistedModel);
	}

	public BasePersistence<Linhvucvanban> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LinhvucvanbanLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		linhvucvanbanLocalService = (LinhvucvanbanLocalService)aopProxy;

		_setLocalServiceUtilService(linhvucvanbanLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LinhvucvanbanLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = LinhvucvanbanLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, linhvucvanbanLocalService);
		}
