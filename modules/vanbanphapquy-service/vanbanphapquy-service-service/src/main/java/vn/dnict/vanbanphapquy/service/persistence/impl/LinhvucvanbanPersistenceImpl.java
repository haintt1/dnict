...
import vn.dnict.vanbanphapquy.model.impl.LinhvucvanbanImpl;
import vn.dnict.vanbanphapquy.model.impl.LinhvucvanbanModelImpl;
...
/**
 * The persistence implementation for the linhvucvanban service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = LinhvucvanbanPersistence.class)
public class LinhvucvanbanPersistenceImpl
	extends BasePersistenceImpl<Linhvucvanban>
	implements LinhvucvanbanPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>LinhvucvanbanUtil</code> to access the linhvucvanban persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		LinhvucvanbanImpl.class.getName();
	 ...
	 */
	@Override
	public List<Linhvucvanban> findByStatus(int status) {
	 ...
	 */
	@Override
	public List<Linhvucvanban> findByStatus(int status, int start, int end) {
	 ...
	 */
	@Override
	public List<Linhvucvanban> findByStatus(
	...
	public List<Linhvucvanban> findByStatus(
		...
		List<Linhvucvanban> list = null;

		if (useFinderCache) {
			list = (List<Linhvucvanban>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (Linhvucvanban linhvucvanban : list) {
					if (status != linhvucvanban.getStatus()) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_LINHVUCVANBAN_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(LinhvucvanbanModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<Linhvucvanban>)QueryUtil.list(
	...
	public Linhvucvanban findByStatus_First(
		...
		Linhvucvanban linhvucvanban = fetchByStatus_First(
		...
		throw new NoSuchLinhvucvanbanException(sb.toString());
	}
	...
	public Linhvucvanban fetchByStatus_First(
		...
		List<Linhvucvanban> list = findByStatus(
	...
	public Linhvucvanban findByStatus_Last(
		...
		Linhvucvanban linhvucvanban = fetchByStatus_Last(
			status, orderByComparator);
	...
	public Linhvucvanban[] findByStatus_PrevAndNext(
		...
		try {
			...
			array[0] = getByStatus_PrevAndNext(
				session, linhvucvanban, status, orderByComparator, true);

			array[1] = linhvucvanban;

			array[2] = getByStatus_PrevAndNext(
				session, linhvucvanban, status, orderByComparator, false);
	...
	protected Linhvucvanban getByStatus_PrevAndNext(
		Session session, Linhvucvanban linhvucvanban, int status,
		OrderByComparator<Linhvucvanban> orderByComparator, boolean previous) {
		...
		List<Linhvucvanban> list = query.list();
	...
	public void removeByStatus(int status) {
		for (Linhvucvanban linhvucvanban :
				findByStatus(
	...
	public int countByStatus(int status) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_LINHVUCVANBAN_WHERE);
	...
	public LinhvucvanbanPersistenceImpl() {
		...
		setModelImplClass(LinhvucvanbanImpl.class);
	...
	public void cacheResult(List<Linhvucvanban> linhvucvanbans) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (linhvucvanbans.size() > _valueObjectFinderCacheListThreshold))) {
	...
	/**
	 * Clears the cache for all linhvucvanbans.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(LinhvucvanbanImpl.class);
	...
	/**
	 * Clears the cache for the linhvucvanban.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	...
	public void clearCache(Linhvucvanban linhvucvanban) {
		entityCache.removeResult(LinhvucvanbanImpl.class, linhvucvanban);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(LinhvucvanbanImpl.class, primaryKey);
		}
	}
	...
	public Linhvucvanban create(long id) {
		...
		linhvucvanban.setCompanyId(CompanyThreadLocal.getCompanyId());
	 ...
	 * Removes the linhvucvanban with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the linhvucvanban
	 * @return the linhvucvanban that was removed
	 * @throws NoSuchLinhvucvanbanException if a linhvucvanban with the primary key could not be found
	 */
	@Override
	public Linhvucvanban remove(Serializable primaryKey)
		...
		try {
			...
			Linhvucvanban linhvucvanban = (Linhvucvanban)session.get(
		...
		catch (NoSuchLinhvucvanbanException noSuchEntityException) {
	...
	protected Linhvucvanban removeImpl(Linhvucvanban linhvucvanban) {
		...
		try {
			...
			if (!session.contains(linhvucvanban)) {
				linhvucvanban = (Linhvucvanban)session.get(
					LinhvucvanbanImpl.class, linhvucvanban.getPrimaryKeyObj());
			}
	...
	public Linhvucvanban updateImpl(Linhvucvanban linhvucvanban) {
		...
		if (!(linhvucvanban instanceof LinhvucvanbanModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(linhvucvanban.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					linhvucvanban);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in linhvucvanban proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom Linhvucvanban implementation " +
					linhvucvanban.getClass());
		}

		LinhvucvanbanModelImpl linhvucvanbanModelImpl =
			(LinhvucvanbanModelImpl)linhvucvanban;
		...
		try {
			...
			if (isNew) {
				...
				linhvucvanban = (Linhvucvanban)session.merge(linhvucvanban);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		entityCache.putResult(
			LinhvucvanbanImpl.class, linhvucvanbanModelImpl, false, true);
	...
	/**
	 * Returns the linhvucvanban with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the linhvucvanban
	 ...
	 */
	@Override
	public List<Linhvucvanban> findAll() {
	...
	public List<Linhvucvanban> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_LINHVUCVANBAN);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_LINHVUCVANBAN);
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_LINHVUCVANBAN;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return LinhvucvanbanModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the linhvucvanban persistence.
	 */
	@Activate
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new LinhvucvanbanModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", Linhvucvanban.class.getName()));
		...
		_setLinhvucvanbanUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setLinhvucvanbanUtilPersistence(null);

		entityCache.removeCache(LinhvucvanbanImpl.class.getName());
	...
	private void _setLinhvucvanbanUtilPersistence(
		LinhvucvanbanPersistence linhvucvanbanPersistence) {

		try {
			Field field = LinhvucvanbanUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, linhvucvanbanPersistence);
		}
	...
	private static final String _SQL_SELECT_LINHVUCVANBAN =
		"SELECT linhvucvanban FROM Linhvucvanban linhvucvanban";

	private static final String _SQL_SELECT_LINHVUCVANBAN_WHERE =
		"SELECT linhvucvanban FROM Linhvucvanban linhvucvanban WHERE ";

	private static final String _SQL_COUNT_LINHVUCVANBAN =
		"SELECT COUNT(linhvucvanban) FROM Linhvucvanban linhvucvanban";

	private static final String _SQL_COUNT_LINHVUCVANBAN_WHERE =
		"SELECT COUNT(linhvucvanban) FROM Linhvucvanban linhvucvanban WHERE ";
	...
	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No Linhvucvanban exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		LinhvucvanbanPersistenceImpl.class);
	...
	private static class LinhvucvanbanModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			LinhvucvanbanModelImpl linhvucvanbanModelImpl =
				(LinhvucvanbanModelImpl)baseModel;

			long columnBitmask = linhvucvanbanModelImpl.getColumnBitmask();

			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(linhvucvanbanModelImpl, columnNames, original);
			}
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |=
						linhvucvanbanModelImpl.getColumnBitmask(columnName);
				}

				if (finderPath.isBaseModelResult() &&
					(LinhvucvanbanPersistenceImpl.
		...
		private static Object[] _getValue(
			LinhvucvanbanModelImpl linhvucvanbanModelImpl, String[] columnNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						linhvucvanbanModelImpl.getColumnOriginalValue(
							columnName);
				}
				else {
					arguments[i] = linhvucvanbanModelImpl.getColumnValue(
						columnName);
				}
			}
