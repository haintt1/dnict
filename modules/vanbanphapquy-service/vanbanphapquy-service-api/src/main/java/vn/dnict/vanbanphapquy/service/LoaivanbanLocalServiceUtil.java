 ...
 * <code>vn.dnict.vanbanphapquy.service.impl.LoaivanbanLocalServiceImpl</code> and
...
public class LoaivanbanLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>vn.dnict.vanbanphapquy.service.impl.LoaivanbanLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Loaivanban addLoaivanban(Loaivanban loaivanban) {
	 ...
	 */
	public static Loaivanban createLoaivanban(long id) {
	 ...
	 */
	public static Loaivanban deleteLoaivanban(Loaivanban loaivanban) {
	 ...
	 */
	public static Loaivanban deleteLoaivanban(long id) throws PortalException {
	...
	public static Loaivanban fetchLoaivanban(long id) {
	 ...
	 * @throws PortalException if a loaivanban with the primary key could not be found
	 */
	public static Loaivanban getLoaivanban(long id) throws PortalException {
	 ...
	 */
	public static List<Loaivanban> getLoaivanbans(int start, int end) {
	 ...
	 */
	public static Loaivanban updateLoaivanban(Loaivanban loaivanban) {
	...
	private static volatile LoaivanbanLocalService _service;
