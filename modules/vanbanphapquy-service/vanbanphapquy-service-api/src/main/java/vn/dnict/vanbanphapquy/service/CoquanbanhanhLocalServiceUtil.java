...
/**
 * Provides the local service utility for Coquanbanhanh. This utility wraps
 * <code>vn.dnict.vanbanphapquy.service.impl.CoquanbanhanhLocalServiceImpl</code> and
...
public class CoquanbanhanhLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>vn.dnict.vanbanphapquy.service.impl.CoquanbanhanhLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Coquanbanhanh addCoquanbanhanh(Coquanbanhanh coquanbanhanh) {
	 ...
	 */
	public static Coquanbanhanh createCoquanbanhanh(long id) {
		return getService().createCoquanbanhanh(id);
	}
	 ...
	 */
	public static Coquanbanhanh deleteCoquanbanhanh(
		Coquanbanhanh coquanbanhanh) {

		return getService().deleteCoquanbanhanh(coquanbanhanh);
	}
	 ...
	 */
	public static Coquanbanhanh deleteCoquanbanhanh(long id)
		throws PortalException {

		return getService().deleteCoquanbanhanh(id);
	}
	...
	public static Coquanbanhanh fetchCoquanbanhanh(long id) {
		return getService().fetchCoquanbanhanh(id);
	}
	 ...
	 * @throws PortalException if a coquanbanhanh with the primary key could not be found
	 */
	public static Coquanbanhanh getCoquanbanhanh(long id)
		throws PortalException {

		return getService().getCoquanbanhanh(id);
	}
	 ...
	 */
	public static List<Coquanbanhanh> getCoquanbanhanhs(int start, int end) {
	 ...
	 */
	public static Coquanbanhanh updateCoquanbanhanh(
		Coquanbanhanh coquanbanhanh) {
	...
	private static volatile CoquanbanhanhLocalService _service;
