...
public interface VanbanphapquyLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.vanbanphapquy.service.impl.VanbanphapquyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the vanbanphapquy local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link VanbanphapquyLocalServiceUtil} if injection and service tracking are not available.
	 */
