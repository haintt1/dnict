...
/**
 * This class is used by SOAP remote services, specifically {@link vn.dnict.vanbanphapquy.service.http.CoquanbanhanhServiceSoap}.
 *
 * @author BinhNT
...
public class CoquanbanhanhSoap implements Serializable {
	...
	public static CoquanbanhanhSoap[] toSoapModels(List<Coquanbanhanh> models) {
		List<CoquanbanhanhSoap> soapModels = new ArrayList<CoquanbanhanhSoap>(
			models.size());
