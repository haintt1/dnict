...
/**
 * This class is used by SOAP remote services, specifically {@link vn.dnict.vanbanphapquy.service.http.LoaivanbanServiceSoap}.
 *
 * @author BinhNT
...
public class LoaivanbanSoap implements Serializable {
	...
	public static LoaivanbanSoap[] toSoapModels(List<Loaivanban> models) {
		List<LoaivanbanSoap> soapModels = new ArrayList<LoaivanbanSoap>(
			models.size());
