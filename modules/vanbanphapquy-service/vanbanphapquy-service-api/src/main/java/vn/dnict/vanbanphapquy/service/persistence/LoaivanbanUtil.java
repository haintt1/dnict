...
/**
 * The persistence utility for the loaivanban service. This utility wraps <code>vn.dnict.vanbanphapquy.service.persistence.impl.LoaivanbanPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class LoaivanbanUtil {
	 ...
	 */
	public static Map<Serializable, Loaivanban> fetchByPrimaryKeys(
	 ...
	 */
	public static Loaivanban update(
		Loaivanban loaivanban, ServiceContext serviceContext) {
	 ...
	 */
	public static List<Loaivanban> findByStatus(int status) {
	 ...
	 */
	public static List<Loaivanban> findByStatus(
	 ...
	 */
	public static Loaivanban findByStatus_First(
			int status, OrderByComparator<Loaivanban> orderByComparator)
		throws vn.dnict.vanbanphapquy.exception.NoSuchLoaivanbanException {
	 ...
	 */
	public static Loaivanban fetchByStatus_First(
		int status, OrderByComparator<Loaivanban> orderByComparator) {
	 ...
	 * @throws NoSuchLoaivanbanException if a matching loaivanban could not be found
	 */
	public static Loaivanban findByStatus_Last(
			int status, OrderByComparator<Loaivanban> orderByComparator)
		throws vn.dnict.vanbanphapquy.exception.NoSuchLoaivanbanException {
	 ...
	 */
	public static Loaivanban fetchByStatus_Last(
		int status, OrderByComparator<Loaivanban> orderByComparator) {
	 ...
	 */
	public static Loaivanban[] findByStatus_PrevAndNext(
			long id, int status,
			OrderByComparator<Loaivanban> orderByComparator)
		throws vn.dnict.vanbanphapquy.exception.NoSuchLoaivanbanException {
	 ...
	 */
	public static void cacheResult(Loaivanban loaivanban) {
	 ...
	 */
	public static void cacheResult(List<Loaivanban> loaivanbans) {
	 ...
	 */
	public static Loaivanban create(long id) {
	 ...
	 * @throws NoSuchLoaivanbanException if a loaivanban with the primary key could not be found
	 */
	public static Loaivanban remove(long id)
		throws vn.dnict.vanbanphapquy.exception.NoSuchLoaivanbanException {

		return getPersistence().remove(id);
	}

	public static Loaivanban updateImpl(Loaivanban loaivanban) {
	 ...
	 * @throws NoSuchLoaivanbanException if a loaivanban with the primary key could not be found
	 */
	public static Loaivanban findByPrimaryKey(long id)
		throws vn.dnict.vanbanphapquy.exception.NoSuchLoaivanbanException {
	 ...
	 */
	public static Loaivanban fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<Loaivanban> findAll() {
	 ...
	 */
	public static List<Loaivanban> findAll(int start, int end) {
	...
	private static volatile LoaivanbanPersistence _persistence;
