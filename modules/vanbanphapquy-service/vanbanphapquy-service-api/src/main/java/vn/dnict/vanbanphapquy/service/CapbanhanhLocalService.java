...
/**
 * Provides the local service interface for Capbanhanh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author BinhNT
 * @see CapbanhanhLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CapbanhanhLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.vanbanphapquy.service.impl.CapbanhanhLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the capbanhanh local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CapbanhanhLocalServiceUtil} if injection and service tracking are not available.
	 */
