...
/**
 * Provides the local service interface for dinhkemfile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author BinhNT
 * @see dinhkemfileLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface dinhkemfileLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.vanbanphapquy.service.impl.dinhkemfileLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dinhkemfile local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link dinhkemfileLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public dinhkemfile adddinhkemfile(dinhkemfile dinhkemfile);
	...
	public dinhkemfile createdinhkemfile(long id);
	...
	public dinhkemfile deletedinhkemfile(dinhkemfile dinhkemfile);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public dinhkemfile deletedinhkemfile(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public dinhkemfile fetchdinhkemfile(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public dinhkemfile getdinhkemfile(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<dinhkemfile> getdinhkemfiles(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public dinhkemfile updatedinhkemfile(dinhkemfile dinhkemfile);
