...
public interface LinhvucvanbanLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.vanbanphapquy.service.impl.LinhvucvanbanLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the linhvucvanban local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LinhvucvanbanLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Linhvucvanban deleteLinhvucvanban(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Linhvucvanban fetchLinhvucvanban(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Linhvucvanban getLinhvucvanban(long id) throws PortalException;
