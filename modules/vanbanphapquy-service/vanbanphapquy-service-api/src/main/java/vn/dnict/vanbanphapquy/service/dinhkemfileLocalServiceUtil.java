...
/**
 * Provides the local service utility for dinhkemfile. This utility wraps
 * <code>vn.dnict.vanbanphapquy.service.impl.dinhkemfileLocalServiceImpl</code> and
 ...
 * @generated
 */
public class dinhkemfileLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>vn.dnict.vanbanphapquy.service.impl.dinhkemfileLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static dinhkemfile adddinhkemfile(dinhkemfile dinhkemfile) {
		return getService().adddinhkemfile(dinhkemfile);
	}
	 ...
	 */
	public static dinhkemfile createdinhkemfile(long id) {
		return getService().createdinhkemfile(id);
	}
	 ...
	 */
	public static dinhkemfile deletedinhkemfile(dinhkemfile dinhkemfile) {
		return getService().deletedinhkemfile(dinhkemfile);
	}
	 ...
	 */
	public static dinhkemfile deletedinhkemfile(long id)
		throws PortalException {

		return getService().deletedinhkemfile(id);
	}
	...
	public static dinhkemfile fetchdinhkemfile(long id) {
		return getService().fetchdinhkemfile(id);
	}
	 ...
	 * @throws PortalException if a dinhkemfile with the primary key could not be found
	 */
	public static dinhkemfile getdinhkemfile(long id) throws PortalException {
		return getService().getdinhkemfile(id);
	}
	 ...
	 */
	public static List<dinhkemfile> getdinhkemfiles(int start, int end) {
		return getService().getdinhkemfiles(start, end);
	}
	 ...
	 */
	public static int getdinhkemfilesCount() {
		return getService().getdinhkemfilesCount();
	}
	 ...
	 */
	public static dinhkemfile updatedinhkemfile(dinhkemfile dinhkemfile) {
		return getService().updatedinhkemfile(dinhkemfile);
	}

	public static dinhkemfileLocalService getService() {
		return _service;
	}

	private static volatile dinhkemfileLocalService _service;
