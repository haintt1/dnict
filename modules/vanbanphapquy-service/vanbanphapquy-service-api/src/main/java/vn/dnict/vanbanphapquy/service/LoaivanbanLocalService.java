...
/**
 * Provides the local service interface for Loaivanban. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author BinhNT
 * @see LoaivanbanLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LoaivanbanLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>vn.dnict.vanbanphapquy.service.impl.LoaivanbanLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the loaivanban local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LoaivanbanLocalServiceUtil} if injection and service tracking are not available.
	 */
