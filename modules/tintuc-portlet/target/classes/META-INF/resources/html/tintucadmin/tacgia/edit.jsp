...
%>
<portlet:actionURL name="updateTacGia" var="updateTacGiaURL">
...
<%
String id = ParamUtil.getString(request, "tacgiaid");
News_NguonTin obj = News_NguonTinLocalServiceUtil.fetchNews_NguonTin(Long.valueOf(id));
%>
				...
				<div aria-multiselectable="true" class="panel-group" role="tablist">
					<fieldset aria-labelledby="Title" class=" " role="group">
						<div aria-labelledby="Header" class="in  " id="Content" role="presentation">
							...
							<aui:form name="formAddThongTin" action="<%=updateTacGiaURL %>"
								method="post">
								<table class="tbcoreadmin" style="width: 100%">
									<tr>
										<td colspan="100">
											<label class="control-label">Tên thể loại</label>
											<aui:input name="tacgiaid" type="hidden" value="<%=Long.valueOf(id)%>"></aui:input>
											<aui:input name="tacgia" label="" value="<%=obj.getName() %>" type="input">
									...
									<tr>
										<td colspan="1">
											...
											<input id="status" name="status" label="" type="checkbox" style="margin-top: 26px;margin-left: 12px;" checked="<%=obj.getStatus() == 0?true:false %>" />
										</td>
									</tr> -->
									<tr>
