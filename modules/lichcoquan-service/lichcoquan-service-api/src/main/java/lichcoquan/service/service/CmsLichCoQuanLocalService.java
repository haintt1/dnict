...
/**
 * Provides the local service interface for CmsLichCoQuan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author BinhNT
 * @see CmsLichCoQuanLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CmsLichCoQuanLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>lichcoquan.service.service.impl.CmsLichCoQuanLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cms lich co quan local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CmsLichCoQuanLocalServiceUtil} if injection and service tracking are not available.
	 */
