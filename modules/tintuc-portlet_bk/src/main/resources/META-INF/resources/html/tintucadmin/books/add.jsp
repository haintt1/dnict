...
%>
<portlet:actionURL name="saveBooks" var="saveBooksURL"></portlet:actionURL>
				...
				<div aria-multiselectable="true" class="panel-group" role="tablist">
					<fieldset aria-labelledby="Title" class=" " role="group">
						<div aria-labelledby="Header" class="in  " id="Content" role="presentation">
							...
							<aui:form name="frmAddNews" action="<%=saveBooksURL.toString()%>" method="post" enctype="multipart/form-data">
								<table class="tbcoreadmin" style="width: 100%">
									...
									<tr>
										...
										<!-- <aui:input name="urlsmallimage" label="" type="input" value="" cssClass="linkimage"></aui:input> -->
									...
									<tr>
										<td>
											...
											<liferay-ui:input-editor toolbarSet="slimmed" editorImpl="editor.wysiwyg.default" name="contents" resizable="true"  initMethod="initEditor" height="400"></liferay-ui:input-editor>
										</td>
									</tr>
									<tr>
										<td>
