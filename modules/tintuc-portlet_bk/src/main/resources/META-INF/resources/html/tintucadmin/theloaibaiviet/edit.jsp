...
%>
<portlet:actionURL name="updateTheLoai" var="updateTheLoaiURL">
...
<%
String id = ParamUtil.getString(request, "theloaiid");
News_Type obj = News_TypeLocalServiceUtil.fetchNews_Type(Long.valueOf(id));
%>
				...
				<div aria-multiselectable="true" class="panel-group" role="tablist">
					<fieldset aria-labelledby="Title" class=" " role="group">
						<div aria-labelledby="Header" class="in  " id="Content" role="presentation">
							...
							<aui:form name="formAddThongTin" action="<%=updateTheLoaiURL %>"
								method="post">
								<table class="tbcoreadmin" style="width: 100%">
									<tr>
										<td colspan="100">
											<label class="control-label">Tên thể loại</label>
											<aui:input name="theloaiid" type="hidden" value="<%=Long.valueOf(id)%>"></aui:input>
											<aui:input name="theloai" label="" value="<%=obj.getName() %>" type="input">
