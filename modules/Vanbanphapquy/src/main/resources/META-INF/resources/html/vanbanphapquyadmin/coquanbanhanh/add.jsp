...
%>
<portlet:actionURL var="addCoquanbanhanhURL" name="addCoquanbanhanh">
					...
					<fieldset aria-labelledby="Title" class=" " role="group">
						<div aria-labelledby="Header" class="in  " id="Content" role="presentation">
							<div class="panel-body">
								<aui:form action="${addCoquanbanhanhURL }" name="linkForm" method="POST">
									<table class="tbcoreadmin">
										<tr>
											<td class="key label2">Tên cơ quan ban hành</td>
											<td>
