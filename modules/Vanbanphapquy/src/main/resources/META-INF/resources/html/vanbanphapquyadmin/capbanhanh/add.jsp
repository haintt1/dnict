...
%>
<portlet:actionURL var="addCapbanhanhURL" name="addCapbanhanh">
					...
					<fieldset aria-labelledby="Title" class=" " role="group">
						<div aria-labelledby="Header" class="in  " id="Content" role="presentation">
							<div class="panel-body">
								<aui:form action="${addCapbanhanhURL }" name="linkForm" method="POST">
									<table class="tbcoreadmin">
										<tr>
											<td class="key label2">Tên cấp ban hành</td>
											<td>
