...
%>
<portlet:actionURL var="addLoaivanbanURL" name="addLoaivanban">
					...
					<fieldset aria-labelledby="Title" class=" " role="group">
						<div aria-labelledby="Header" class="in  " id="Content" role="presentation">
							<div class="panel-body">
								<aui:form action="${addLoaivanbanURL }" name="linkForm" method="POST">
									<table class="tbcoreadmin">
										<tr>
											<td class="key label2">Tên loại văn bản</td>
											<td>
