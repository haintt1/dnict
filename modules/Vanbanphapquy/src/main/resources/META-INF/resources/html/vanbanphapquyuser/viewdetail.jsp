...
<portlet:renderURL var="viewURL">
	<portlet:param name="jspPage" value="/html/vanbanphapquyuser/view_list.jsp" />
</portlet:renderURL>
<style>
table.fr_tbcore {
    width: 100%;
		...
		<table style="width: 100%">
					...
					<ol>
						...
						<portlet:renderURL var="detailVanbanphapquyURL">
							...
							<portlet:param name="jspPage"
								value="/html/vanbanphapquyuser/viewdetail.jsp" />
						</portlet:renderURL>
			...
			<tr>
				<td style="text-align: center">
					<a href="<%=viewURL%>"><aui:button class="btn-primary" value="Trở lại" /></a>
				</td>
			</tr>
		</table>