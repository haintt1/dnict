...
<%
	...
	Linhvucvanban editLinhvucvanban = (Linhvucvanban) request.getAttribute("editLinhvucvanban");
%>
<portlet:actionURL var="updateLinhvucvanbanURL" name="updateLinhvucvanban">
					...
					<fieldset aria-labelledby="Title" class=" " role="group">
						<div aria-labelledby="Header" class="in  " id="Content" role="presentation">
							<div class="panel-body">
								<aui:form action="<%=updateLinhvucvanbanURL.toString() %>" name="" method="POST">
									<table class="tbcoreadmin">
										<tr>
											<td class="key label2">Tên</td>
											<td>
												<aui:input name="id" type="hidden" value="<%=editLinhvucvanban.getId() %>"/>
												<aui:input name="name" size="40" label="" value="<%=editLinhvucvanban.getName() %>">
										...
										<tr>
											...
											<td>
												<aui:input name="code" size="40" label="" value="<%=editLinhvucvanban.getCode() %>">
													<aui:validator name="required"></aui:validator>
												</aui:input>
											</td>
										</tr>
										<tr>
											...
											<td><aui:input name="status" checked="<%=editLinhvucvanban.getStatus()==1?true:false%>" type="checkbox" label="Hiển thị"/></td>
										</tr>
										<tr>
											<td class="key label2">
